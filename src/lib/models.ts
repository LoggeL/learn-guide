...
export const tierListModels: ModelEntry[] = [
  { id: 'fable-5', nameKey: 'fable5', descKey: 'fable5Desc', tier: 'S+', hosting: 'api' },
  { id: 'gpt-56-sol', nameKey: 'gpt56Sol', descKey: 'gpt56SolDesc', tier: 'A', hosting: 'api' },
  { id: 'kimi-k3', nameKey: 'kimiK3', descKey: 'kimiK3Desc', tier: 'B', hosting: 'api' },
  { id: 'gpt-56-luna', nameKey: 'gpt56Luna', descKey: 'gpt56LunaDesc', tier: 'B', hosting: 'api' },
  { id: 'deepseek-v4-flash', nameKey: 'deepseekV4Flash', descKey: 'deepseekV4FlashDesc', tier: 'B', hosting: 'api' },
  { id: 'grok-46', nameKey: 'grok46', descKey: 'grok46Desc', tier: 'C', hosting: 'api' },
  { id: 'muse-spark-12', nameKey: 'museSpark12', descKey: 'museSpark12Desc', tier: 'C', hosting: 'api' },
  { id: 'opus-5', nameKey: 'opus5', descKey: 'opus5Desc', tier: 'D', hosting: 'api' },
  { id: 'composer-25', nameKey: 'composer25', descKey: 'composer25Desc', tier: 'D', hosting: 'api' },
  { id: 'glm-53', nameKey: 'glm53', descKey: 'glm53Desc', tier: 'D', hosting: 'api' },
  { id: 'gpt-56-terra', nameKey: 'gpt56Terra', descKey: 'gpt56TerraDesc', tier: 'D', hosting: 'api' },
  { id: 'sonnet-5', nameKey: 'sonnet5', descKey: 'sonnet5Desc', tier: 'D', hosting: 'api' },
  { id: 'deepseek-v4-pro', nameKey: 'deepseekV4Pro', descKey: 'deepseekV4ProDesc', tier: 'F', hosting: 'api' },
  { id: 'gemini-37-flash', nameKey: 'gemini37Flash', descKey: 'gemini37FlashDesc', tier: 'Google', hosting: 'api' },
  { id: 'gemini-31-pro', nameKey: 'gemini31Pro', descKey: 'gemini31ProDesc', tier: 'Google', hosting: 'api' },
]

/** Parameterized model presets used by the VRAM calculator. */
export const models: ModelEntry[] = [
  {
    id: 'minimax-m27', nameKey: 'minimax27', descKey: 'minimax27Desc', tier: 'A', hosting: 'open-weight',
    params: '250B MoE → 10B active', totalParamsB: 250, activeParamsB: 10, isMoE: true,
  },
  {
    id: 'glm-5-1', nameKey: 'glm51', descKey: 'glm51Desc', tier: 'A', hosting: 'open-weight',
    params: '744B MoE → 40B active', totalParamsB: 744, activeParamsB: 40, isMoE: true,
    nLayers: 62, dModel: 6144, nKVHeads: 2, headDim: 128,
  },
  {
    id: 'kimi-k26', nameKey: 'kimiK26', descKey: 'kimiK26Desc', tier: 'A', hosting: 'open-weight',
    params: '1T MoE → 32B active', totalParamsB: 1000, activeParamsB: 32, isMoE: true,
    nLayers: 61, dModel: 7168, nKVHeads: 8, headDim: 128,
  },
  {
    id: 'qwen36-27b-a3', nameKey: 'qwen36_27bA3', descKey: 'qwen36_27bA3Desc', tier: 'A', hosting: 'local',
    params: '27B MoE → 3B active', totalParamsB: 27, activeParamsB: 3, isMoE: true,
    nLayers: 64, dModel: 2560, nKVHeads: 4, headDim: 128,
  },
  {
    id: 'llama-maverick', nameKey: 'llamaMaverick', descKey: 'llamaMaverickDesc', tier: 'F', hosting: 'open-weight',
    params: '400B MoE → 17B active', totalParamsB: 400, activeParamsB: 17, isMoE: true,
    nLayers: 48, dModel: 5120, nKVHeads: 8, headDim: 128,
  },
]
...
export const tierConfig: Record<TierLevel, { color: string; bgGradient: string; borderColor: string }> = {
  ...
  Google: { color: 'text-cyan-400', bgGradient: 'from-cyan-500/10 to-blue-500/5', borderColor: 'border-cyan-500/20' },
}
