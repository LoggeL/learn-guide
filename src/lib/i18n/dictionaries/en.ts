export const en = {
  ...
  gettingStarted: {
    ...
    getKeyDesc: 'Use OpenRouter with its free Auto route. It picks an available free model for you, so this guide has only one path to follow — no provider comparison, no model shopping.',
    openrouterDesc: 'OpenRouter Auto (Free) routes your request to an available free model automatically. Great for a first API call because you do not need to choose a specific model.',
    openrouterAutoOnlyDesc: 'OpenRouter Auto (Free) routes your request to an available free model automatically. Create a free OpenRouter key, paste it below, and keep the model as Auto (Free).',
    openrouterAutoOnlyNote: 'This playground intentionally only offers OpenRouter Auto (Free), so beginners do not have to compare providers or pick model IDs.',
    groqDesc: 'Deprecated on this page: use OpenRouter Auto (Free) for the beginner path.',
    cerebrasDesc: 'Deprecated on this page: use OpenRouter Auto (Free) for the beginner path.',
    getKey: 'Get API Key →',
    apiKeyLabel: 'API Key',
