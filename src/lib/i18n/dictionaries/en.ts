export const en = {
  ...
  worldModels: {
    ...
    googleGenieDesc: 'Generates interactive, playable 3D worlds from text descriptions or single images.',
    googleGenieDetail: 'Genie 2 creates consistent, explorable 3D environments with realistic physics. Users can describe a scene in natural language, and the model generates an interactive world that agents can navigate. It supports persistent object states and physically plausible interactions.',
