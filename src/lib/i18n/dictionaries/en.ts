export const en = {
  ...
  topicDescriptions: {
    ...
    'feed-forward-networks-moe': 'How transformer MLP blocks process tokens and how MoE routes tokens through experts.',
  ...
  contextRot: {
    ...
    mitigation1Title: 'Context Engineering',
    mitigation1: 'Treat context as a finite resource with diminishing returns. Anthropic\'s recommended approach: be intentional about what you include and where.',
    mitigation2Title: 'Position-Aware Prompting',
    mitigation2: 'Front-load critical instructions and mirror them at the end. The sandwich technique ensures at least one copy lands in a high-attention zone.',
    mitigation3Title: 'Recursive Chunking',
    mitigation3: 'Split long documents into 400–512 token chunks with 10–20% overlap. This is the best default for retrieval-augmented tasks.',
    mitigation4Title: 'Multi-Agent Architecture',
    mitigation4: 'Split context across specialized agents. Chroma 2025 found a 90.2% improvement over single-agent approaches — each agent gets a fresh, focused context.',
    mitigation5Title: 'Hierarchical Summarization',
    mitigation5: 'Summarize middle content and place summaries at the top. Middle sections stay for reference, but key points are extracted into high-attention zones.',
    interactiveDemo: 'Interactive Demo',
    demoDesc: 'See how memory fades as context length increases',
    keyTakeaways: 'Key Takeaways',
    takeaway1: 'All 18 frontier models tested (GPT-4.1, Claude Opus 4, Gemini 2.5+) degrade — this is architectural, not a bug',
    takeaway2: 'Stanford\'s "Lost in the Middle": 30%+ accuracy drop when info is buried in the middle vs start/end',
    takeaway3: '100K tokens = 10 billion pairwise attention relationships — softmax normalization dilutes each token\'s signal',
    takeaway4: 'Coherent, structured documents degrade performance more than shuffled ones (Chroma 2025 paradox)',
    takeaway5: 'Multi-agent architectures achieve 90.2% improvement by giving each agent a focused, fresh context',
    takeaway6: 'Front-loading + mirroring critical info is the highest-ROI mitigation strategy, recoverable 10–20% accuracy',
    ...
    // Hero stats
    heroIntro: 'A fundamental limitation found in every frontier AI model — not a bug, but an architectural reality.',
    heroStat1Value: '18',
    heroStat1Label: 'Frontier Models All Degrade',
    heroStat2Value: '30%+',
    heroStat2Label: 'Accuracy Drop in the Middle',
    heroStat3Value: '2.55%',
    heroStat3Label: 'GPT Hallucination Rate (long contexts)',
    heroStat4Value: '90.2%',
    heroStat4Label: 'Multi-Agent Improvement',
    // Science section
    scienceTitle: 'The Science: Lost in the Middle',
    scienceDesc: 'Liu et al. (Stanford) demonstrated a U-shaped attention pattern across all tested architectures. Models attend well to the start and end of context, but middle content receives drastically less focus — causing accuracy to drop by 30%+ when critical information is buried in the middle.',
    attentionHeatmapTitle: 'U-Shaped Attention Curve',
    attentionHeatmapDesc: 'Click along the context window to place the needle. Accuracy reflects Liu et al. data — position matters enormously.',
    attentionClickHint: 'Click any position to place the needle',
    attentionAccuracyLabel: 'Retrieval Accuracy',
    attentionStartLabel: 'Start',
    attentionMiddleLabel: 'Middle',
    attentionEndLabel: 'End',
    attentionPositionLabel: 'Position',
    // Chroma 2025 section
    chromaTitle: 'Chroma 2025: 18 Models, Same Result',
    chromaDesc: 'The Chroma benchmark systematically tested GPT-4.1, Claude Opus 4, Gemini 2.5 Pro and 15 other frontier models. The verdict was unambiguous: every single model degrades as context grows.',
    chromaFinding1Title: 'Universal Degradation',
    chromaFinding1Desc: 'All 18 tested models degrade — no exceptions. LongMemEval showed a massive accuracy gap between 300 tokens vs 113K tokens for the exact same information.',
    chromaFinding2Title: 'Similarity Effect',
    chromaFinding2Desc: 'Low semantic similarity between needle and question causes faster degradation. When the needle topic is unrelated to the surrounding text, retrieval collapses more quickly.',
    chromaFinding3Title: 'Coherence Paradox',
    chromaFinding3Desc: 'Counterintuitively, coherent and structured documents hurt performance more than shuffled ones. Coherent text creates stronger semantic interference in the attention mechanism.',
    chromaFinding4Title: 'Model Differences',
    chromaFinding4Desc: 'GPT models show ~2.55% hallucination rate in long contexts. Claude has the lowest rate — it tends to abstain rather than hallucinate when uncertain.',
    // Distractor demo
    distractorTitle: 'Distractor Effect Demo',
    distractorDesc: 'Adjust distractors to see accuracy drop — and toggle between modes to see the coherence paradox in action.',
    distractorSliderLabel: 'Number of Distractors',
    distractorShuffledLabel: 'Shuffled',
    distractorCoherentLabel: 'Coherent',
    distractorModeLabel: 'Haystack Mode',
    distractorAccuracyLabel: 'Accuracy',
    distractorParadoxNote: 'Coherent context degrades performance faster — structured text creates stronger interference patterns in attention. This is the Chroma 2025 paradox.',
    // Scale section
    scaleTitle: 'The Quadratic Scale Problem',
    scaleDesc: 'Transformer attention is O(n²) — the number of pairwise relationships grows quadratically with context length. Softmax normalizes attention scores across all tokens, meaning each token receives less attention as context grows. This is physics, not a fixable bug.',
    scaleCalculatorTitle: 'Attention Complexity Calculator',
    scaleInputLabel: 'Context Length (tokens)',
    scalePairwiseLabel: 'Pairwise Relationships',
    scaleAttentionLabel: 'Attention per Token',
    scaleReferenceTitle: 'Reference Scale',
    // Checklist
    checklistTitle: 'Practical Checklist',
    checklist1: 'Front-load critical instructions — place them in the first 5% of your context',
    checklist2: 'Mirror key requirements at the end of long prompts (sandwich technique)',
    checklist3: 'Use recursive chunking (400–512 tokens, 10–20% overlap) for long documents',
    checklist4: 'For tasks exceeding 5 steps, consider a multi-agent architecture',
    checklist5: 'Summarize middle sections and place the summary at the top',
    checklist6: 'Test prompts at 2× and 5× the context length you expect in production',
  },
  ...
  vision: {
    ...
    tokenExample1: '1024×1024 photo (patch-based, GPT-5-mini)',
    tokenExample1Value: '~1,660 tokens',
    tokenExample2: '2048×1024 diagram (tile-based, GPT-4o)',
    ...
    imgTokenTitle: 'Image Tokenization in Practice',
    imgTokenDesc: 'Understanding how providers convert images into tokens is essential for estimating costs and optimizing performance.',
    imgTokenDisclaimer: 'Different providers (OpenAI, Anthropic, Google) handle image tokenization differently. The specifics below are based on OpenAI\'s documented approach, but the general principles apply across providers.',
    imgTokenPatchTitle: 'Patch-Based Tokenization',
    imgTokenPatchModels: 'Newer models: GPT-5 series, o4-mini',
    imgTokenPatchDesc: 'Images are covered with 32×32 pixel patches. Each patch becomes tokens. Models have a patch budget (e.g. 1,536 or 2,500 patches max). If the image exceeds the budget, it\'s scaled down proportionally. A model-specific multiplier converts patches to billed tokens.',
    imgTokenPatchMultipliers: 'Example multipliers: gpt-5-mini → 1.62×, gpt-5-nano → 2.46×, o4-mini → 1.72×',
    imgTokenTileTitle: 'Tile-Based Tokenization',
    imgTokenTileModels: 'Older models: GPT-4o, GPT-4.1, o-series',
    imgTokenTileDesc: 'The image is scaled to fit within 2048×2048, then the shortest side is scaled to 768px. The result is counted in 512×512 tiles. Each tile costs a fixed number of tokens (e.g. 170) plus base tokens (e.g. 85).',
    imgTokenDetailTitle: 'Detail Levels',
    imgTokenDetailLow: 'Low — Fixed 512×512 downscale, cheapest option',
    imgTokenDetailHigh: 'High — Standard processing at full resolution',
    imgTokenDetailOriginal: 'Original — Up to 6000px, available in GPT-5.4+',
    imgTokenDetailAuto: 'Auto — Model decides which level to use',
    imgTokenCalcTitle: 'Cost Calculation (Patch-Based)',
    imgTokenCalcStep1: 'patches = ⌈width / 32⌉ × ⌈height / 32⌉',
    imgTokenCalcStep2: 'If patches > budget → scale down proportionally',
    imgTokenCalcStep3: 'final_tokens = resized_patches × model_multiplier',
    imgTokenCalcExample: 'Example: A 1024×1024 image → ⌈1024/32⌉ × ⌈1024/32⌉ = 32 × 32 = 1,024 patches. With GPT-5-mini (1.62× multiplier) → ~1,660 tokens.',
    imgTokenFormats: 'Supported formats: PNG, JPEG, WEBP, non-animated GIF. Up to 50 MB per request, up to 500 images per request.',
    imgTokenLimitationsTitle: 'Known Limitations',
    imgTokenLimitation1: 'Medical/scientific images — not trained for diagnostic accuracy',
    imgTokenLimitation2: 'Non-Latin text and small text — OCR quality drops significantly',
    imgTokenLimitation3: 'Rotated or upside-down images — may misinterpret orientation',
    imgTokenLimitation4: 'Spatial reasoning — struggles with precise locations and distances',
    imgTokenLimitation5: 'Counting objects — unreliable above ~10 items',
    // Use cases
  ...
  agentContext: {
    ...
    pitfallOverflowDesc: 'Exceeding the context window causes truncation. The model loses access to earlier information, potentially forgetting instructions or important context.',
    ...
    pitfallMiddleDesc: 'Models pay less attention to information in the middle of long contexts. Place critical information at the start or end.',
  ...
  mcp: {
    ...
    vsCliMcpPro1: 'Structured JSON input/output — no parsing needed',
    vsCliMcpPro2: 'Typed schemas with validation — LLM knows exact parameters',
    vsCliMcpPro3: 'Persistent connections — stateful sessions (e.g., DB connection pools)',
    vsCliCliPro1: 'Zero setup — if the CLI exists, it works immediately',
    vsCliCliPro2: 'Massive ecosystem — thousands of tools already installed on any system',
    vsCliCliPro3: 'Composable — pipe, grep, jq, awk for complex transformations',
    vsCliRowSetup: 'Setup',
    vsCliRowSetupMcp: 'Config + server process',
    vsCliRowSetupCli: 'Already installed',
    vsCliRowSpeed: 'Latency',
    vsCliRowSpeedMcp: 'Protocol overhead',
    vsCliRowSpeedCli: 'Direct exec (~ms)',
    vsCliRowSecurity: 'Security',
    vsCliRowSecurityMcp: 'Sandboxed, scoped permissions',
    vsCliRowSecurityCli: 'Full shell access ⚠️',
    vsCliRowEcosystem: 'Ecosystem',
    vsCliRowEcosystemMcp: '~3K servers (growing)',
    vsCliRowEcosystemCli: '~100K+ tools (mature)',
    ...
    vsCliVerdictDesc: 'CLI tools are the pragmatic default: they\'re already everywhere, agents can use them immediately, and the Unix philosophy of composable commands is surprisingly well-suited for LLMs. MCP shines when you need structured schemas (fewer hallucinated arguments), persistent state (DB connections), or cross-platform portability. In practice, the best agents use both: CLI for quick system tasks, MCP for complex integrations that benefit from type safety.',
  ...
  diffusionFundamentals: {
    ...
    interactiveTitle: 'Noise-to-Signal Visualizer',
    interactiveDesc: 'Adjust noise manually or autoplay forward/reverse to see how structure fades and re-emerges.',
    keyTakeaways: 'Key Takeaways',
    takeaway1: 'Diffusion training learns to invert a known corruption process.',
    takeaway2: 'Reverse sampling is iterative refinement, not one-step generation.',
  ...
  textDiffusion: {
    ...
    paddingTokensDesc: 'Batched diffusion often uses fixed sequence length. [PAD] tokens fill unused positions and attention masks prevent them from influencing content tokens.',
    ...
    interactiveDesc: 'Watch [MASK] positions reveal and refine token by token, with [PAD] positions held out via masking.',
    keyTakeaways: 'Key Takeaways',
  ...
  imageDiffusion: {
    ...
    latentPipelineDesc: 'Modern systems typically diffuse in latent space for efficiency: encode image latents with a VAE, denoise those latents, then decode back to pixels.',
    ...
    interactiveTitle: 'Interactive Noise and Denoise Demo',
    interactiveDesc: 'Use the visualizer to simulate forward noising and reverse denoising in a diffusion-style process.',
    keyTakeaways: 'Key Takeaways',
    takeaway1: 'Latent diffusion improves compute efficiency while preserving output quality.',
  ...
  programmaticTools: {
    ...
    whyMattersDesc: 'Traditional tool use requires the model to generate a tool call, wait for the result, then decide the next step — one round-trip at a time. Programmatic tool calling eliminates this overhead for multi-step workflows.',
    ...
    traditionalFlow: 'Each tool call requires a full model round-trip. For N tools, that\'s N inference passes.',
    programmaticFlow: 'Agent writes one script calling N tools. Only 1 inference pass needed.',
    ...
    programmaticSteps: 'Model → code (3 tool calls + aggregation) → final answer',
    traditionalLabel: '7 model turns',
    programmaticLabel: '2 model turns',
    useCases: 'Use Cases',
    ...
    allowedCallersDesc: 'When defining tools, you specify which contexts can invoke them. This controls whether a tool can only be called directly by the model, only from within code execution, or both.',
    ...
    codeOnlyDesc: 'The tool can only be invoked from within a sandboxed code execution environment.',
    ...
    takeaway2: 'Intermediate results stay in the sandbox and never enter the model\'s context window, saving tokens.',
    takeaway3: 'Use allowed_callers to control whether tools are invoked directly, from code, or both.',
  ...
  systemPrompts: {
    ...
    specialTokensDesc: 'The Chat API uses three roles: system, user, and assistant. Under the hood, these are separated by special tokens that the model learned during training. For example, ChatML uses <|im_start|>system, while Llama uses [INST] <<SYS>>. The model treats system differently because it was trained to.',
    primacyBias: 'Primacy Bias',
    primacyBiasDesc: 'The system prompt sits at the very beginning of the context window. Research shows models pay more attention to the start and end of their context (primacy and recency bias). This privileged position is why system prompts have outsized influence on behavior.',
    stateless: 'Stateless by Design',
    statelessDesc: 'Models don\'t \u201cremember\u201d your system prompt between API calls. It\'s re-sent with every request. This means your system prompt consumes tokens on every call\u2014a 500-token system prompt across 1000 requests is 500K tokens just for instructions.',
    apiExample: 'What the API Actually Sees',
    howModelsLearn: 'How Models Learn to Follow System Prompts',
    howModelsLearnDesc: 'Models aren\'t born knowing what a system prompt is. They learn to respect it through multiple training phases.',
    ...
    hierarchySolution: 'The Solution: System > User > Tool',
    hierarchySolutionDesc: 'The instruction hierarchy establishes a clear priority: system prompts override user messages, which override tool outputs. Models are trained with synthetic data where user messages attempt to override system instructions\u2014and the model learns to refuse.',
    ...
    hierarchyResultsDesc: '63% improvement in system prompt extraction defense. 30% improvement in jailbreak resistance. Models become significantly more robust against manipulation attempts.',
  ...
  trainingData: {
    ...
    futureRegulationDesc: 'The EU AI Act requires transparency about training data for high-risk AI systems. Copyright lawsuits are establishing legal precedent. The trend is toward more disclosure and potentially licensing requirements for training data.',
  ...
  kvCache: {
    ...
    turboQuantDesc: 'Traditional vector quantization adds 1–2 extra bits of memory overhead per number because it must store quantization constants (zero point + scale) in full precision for every data block. Google\'s three-paper family eliminates this overhead entirely, reaching state-of-the-art compression ratios with zero accuracy loss. TurboQuant (ICLR 2026) is the combined system; PolarQuant (AISTATS 2026) handles the main compression; QJL (AAAI 2025) corrects residual error.',
    polarQuantTitle: 'PolarQuant — the core compressor',
    polarQuantDesc: 'Instead of quantizing Cartesian coordinates (x, y, z…) and storing a scale per block, PolarQuant converts each KV vector into polar coordinates: one radius (how strong the signal is) and angles (which direction it points). After a random rotation preconditioner, the angles follow a tightly concentrated, analytically known distribution — so no scale factor needs to be stored. Result: >4.2× KV cache compression with best-in-class quality on long-context benchmarks.',
  ...
  abliteration: {
    ...
    diagramAblatedDesc: 'The model can no longer represent the refusal direction — it won\'t refuse any request.',
    diagramActiveDesc: 'Layer 16 has the strongest refusal direction. This single vector controls whether the model says "I cannot help with that."',
  ...
  promptCaching: {
    ...
    animTitle: 'Prompt Structure',
    animDesc: 'Cache Hit saved significant time and cost by reusing precomputed KV pairs!',
    ...
    costModelDesc: 'A useful rule of thumb: cache writes are often more expensive than normal input, cache reads are cheaper, and the break-even point depends on how often the same prefix is reused before expiry. Use the calculator as an intuition builder, then confirm with real usage fields from your API responses.',
  ...
  mtp: {
    ...
    demoDesc: 'MTP usually keeps the next-token objective as the strongest signal, then adds weaker auxiliary losses for farther future tokens.',
    ...
    training3Desc: 'The next-token loss usually remains central, while farther-future losses are weighted so they help representation learning without destabilizing training.',
