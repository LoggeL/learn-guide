export const en = {
  ...
  tierList: {
    ...
    deepseekV32Desc: 'Super cheap and smart, but slow. Great value for non-time-sensitive tasks.',
    ...
    claudeSonnet46Desc: 'Still a very strong reliable everyday model, but no longer S-tier for me.',
    qwen36_35bA3: 'Qwen 3.6 35B-A3',
    qwen36_35bA3Desc: 'Ridiculously good for the size. Fast, cheap to run, and strong enough to deserve S-tier locally.',
