export const en = {
  ...
  interactive: {
    ...
    diffusionNoiseTitle: 'Forward/Reverse Noise Process',
    diffusionNoiseDesc: 'Slide manually or autoplay to see signal-to-noise transitions.',
    diffusionNoiseLevel: 'Noise level',
    diffusionNoiseSignal: 'Signal-dominant',
    diffusionNoiseNoisy: 'Noise-dominant',
    diffusionPlayForward: 'Play forward',
    diffusionPlayReverse: 'Play reverse',
    diffusionPause: 'Pause',
    diffusionReset: 'Reset',
    diffusionAutoplayHint: 'Forward autoplay simulates corruption; reverse autoplay simulates denoising.',

    // Text Diffusion Demo
    textDiffusionDemoTitle: 'Iterative Mask Refinement',
    textDiffusionDemoDesc: 'Text diffusion reveals then refines tokens across multiple denoising passes.',
    textDiffusionStart: 'Start',
    textDiffusionReplay: 'Replay',
    textDiffusionStepLabel: 'Step',
    textDiffusionPhaseReveal: 'Phase: reveal masked tokens',
    textDiffusionPhaseRefine: 'Phase: refine token choices',
    textDiffusionPhaseDone: 'Phase: final denoised sequence',
    textDiffusionLegendMask: '[MASK] = unknown token',
    textDiffusionLegendPad: '[PAD] = padded slot',
    textDiffusionLegendToken: 'token = current model guess',
    textDiffusionPaddingTitle: 'Why [PAD] Tokens Matter',
    textDiffusionPaddingDesc: 'Fixed-length batching keeps tensor shapes uniform, but extra positions should not affect content modeling.',
    textDiffusionPaddingPoint1: 'Use [PAD] to fill unused sequence positions up to a fixed length.',
    textDiffusionPaddingPoint2: 'Apply attention masking so padded positions are ignored during scoring.',
    textDiffusionPaddingPoint3: 'This keeps computation efficient and stable across mixed-length examples.',
