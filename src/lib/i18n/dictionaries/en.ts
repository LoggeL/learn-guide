export const en = {
  ...
  topicNames: {
    ...
    'speculative-coding': 'Speculative Coding',
  ...
  // Speculative Coding page
  speculativeCoding: {
    title: 'Speculative Coding',
    description: 'How AI agents use parallel exploration to find optimal solutions faster by pursuing multiple approaches simultaneously.',

    whatIs: 'What is Speculative Coding?',
    whatIsDesc: 'Speculative coding is an agent pattern where the AI explores multiple solution paths in parallel rather than committing to a single approach upfront. Instead of making one decision and following it linearly, the agent "speculates" on several possible directions simultaneously.',
    whatIsDesc2: 'This technique is particularly powerful when the optimal path is unclear, when different approaches have significant trade-offs, or when early feedback can help eliminate suboptimal branches quickly.',

    cpuInspiration: 'Inspired by CPU Architecture',
    cpuInspirationDesc: 'The concept borrows from speculative execution in modern CPUs, where processors predict which branch of code will execute next and begin processing it before knowing for certain. If the prediction is wrong, the work is discarded. In AI agents, we apply the same principle to solution exploration.',
    cpuApproach: 'CPU Speculative Execution',
    cpuApproachDesc: 'Predicts branch outcomes and executes instructions ahead of time. Wrong predictions are rolled back, but correct predictions save significant time.',
    agentApproach: 'Agent Speculative Coding',
    agentApproachDesc: 'Explores multiple solution branches concurrently. Unsuccessful paths are abandoned, while successful ones are merged or selected.',

    howItWorks: 'How It Works',
    howItWorksDesc: 'The agent follows a structured process to maximize the benefits of parallel exploration while managing computational overhead.',
    step1Title: 'Branch Identification',
    step1Desc: 'The agent analyzes the problem and identifies multiple viable approaches. Each branch represents a distinct solution strategy with its own assumptions and trade-offs.',
    step2Title: 'Parallel Exploration',
    step2Desc: 'Multiple sub-agents or threads pursue different branches simultaneously. Each explores its approach independently, building partial solutions.',
    step3Title: 'Progress Evaluation',
    step3Desc: 'The agent continuously monitors progress across branches. Dead ends are detected early through validation checks, compilation errors, or test failures.',
    step4Title: 'Branch Selection or Merge',
    step4Desc: 'The winning branch is selected based on success criteria, or multiple successful branches are merged to combine the best elements of each approach.',

    useCases: 'When to Use Speculative Coding',
    useCasesDesc: 'Speculative coding is most effective in scenarios where the solution space is uncertain or where different approaches have distinct advantages.',
    useCase1: 'Algorithm Selection',
    useCase1Desc: 'When multiple algorithms could solve the problem (e.g., iterative vs. recursive, BFS vs. DFS), try both and pick the one that works best for the specific input.',
    useCase2: 'Library/Framework Choice',
    useCase2Desc: 'Prototype implementations with different libraries to identify which has better API ergonomics, performance, or compatibility with existing code.',
    useCase3: 'Debugging Hypotheses',
    useCase3Desc: 'When a bug could have multiple root causes, investigate each hypothesis in parallel rather than sequentially testing one at a time.',
    useCase4: 'Architecture Exploration',
    useCase4Desc: 'When designing a new feature, sketch out multiple architectural approaches to evaluate trade-offs before committing to implementation.',

    tradeoffs: 'Trade-offs',
    benefits: 'Benefits',
    benefit1: 'Faster convergence on optimal solutions',
    benefit2: 'Early elimination of dead-end approaches',
    benefit3: 'Better exploration of the solution space',
    benefit4: 'Reduced risk of getting stuck on suboptimal paths',
    challenges: 'Challenges',
    challenge1: 'Higher computational cost from parallel work',
    challenge2: 'Complexity in managing multiple branches',
    challenge3: 'Potential for wasted work on abandoned branches',
    challenge4: 'Requires clear success criteria for branch selection',

    realWorld: 'Real-World Example',
    realWorldDesc: 'Consider an agent tasked with fixing a failing test. Instead of trying one fix at a time, it explores multiple hypotheses:',
    exampleComment: '// Agent receives: "test_user_login is failing"',
    exampleTask: 'Fix the failing test',
    exampleBranch1: 'Branch A: Authentication Logic',
    exampleBranch1Desc: '→ Investigates token generation and validation',
    exampleBranch2: 'Branch B: Database State',
    exampleBranch2Desc: '→ Checks test fixtures and user seeding',
    exampleBranch3: 'Branch C: API Contract',
    exampleBranch3Desc: '→ Verifies request/response format changes',
    exampleResult: '✓ Branch B succeeds: Missing user fixture found and added',

    keyTakeaways: 'Key Takeaways',
    takeaway1: 'Speculative coding trades compute for faster convergence by exploring multiple paths simultaneously',
    takeaway2: 'It works best when the solution space is uncertain or when approaches have distinct trade-offs',
    takeaway3: 'Early branch pruning based on validation signals minimizes wasted computation',
    takeaway4: 'The pattern is inspired by CPU speculative execution but applied to higher-level problem solving',
  },
}
