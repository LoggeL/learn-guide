export const en = {
  ...
  worldModels: {
    ...
    keyInsightQuote: 'The next frontier of AI is not just understanding language — it\'s understanding the physical world.',
    keyInsightAttribution: '— Yann LeCun, Meta AI Chief Scientist, on the importance of world models for AGI',
    ...
    comparisonTitle: 'Training Comparison',
    comparisonSubtitle: 'Toggle between real world and world model training to see the differences',
    realWorldTraining: 'Real World Training',
    worldModelTraining: 'World Model Training',
    compSpeed: 'Speed',
    compSpeedReal: '1x realtime',
    compSpeedWorld: '1,000x–430,000x realtime',
    compCost: 'Cost',
    compCostReal: '$100k+ per robot',
    compCostWorld: 'GPU compute only',
    compParallel: 'Parallelization',
    compParallelReal: '1 robot = 1 instance',
    compParallelWorld: '1000s of parallel instances',
    compSafety: 'Safety',
    compSafetyReal: 'Risk of damage & injury',
    compSafetyWorld: 'Zero physical risk',
    compDiversity: 'Scenario Diversity',
    compDiversityReal: 'Limited by physical setup',
    compDiversityWorld: 'Unlimited procedural generation',
    trainingLoopTitle: 'The Robotics Training Loop',
    trainingLoopDesc: 'World Models enable a continuous improvement cycle: simulate scenarios, train policies, evaluate in the real world, collect data to refine the model, and repeat. Each iteration makes both the world model and the robot policy better.',
    simToRealTitle: 'The Sim-to-Real Gap',
    simToRealIntro: 'The biggest challenge in simulation-based training: what works perfectly in a simulated world may fail in reality. Differences in physics, sensor noise, lighting, and material properties create a "gap" that researchers work hard to close.',
    examples: 'Notable World Models',
    nvidiaCosmos: 'NVIDIA Cosmos',
    nvidiaCosmosDesc: 'Open-source Physical AI platform generating synthetic training data for robotics and autonomous driving. Uses video foundation models to simulate complex driving scenarios with realistic physics.',
    googleGenie: 'Google Genie 2',
    googleGenieDesc: 'Generates interactive, playable 3D worlds from text descriptions or images. Creates consistent environments with realistic physics and supports agent interaction.',
    uniSim: 'UniSim',
    uniSimDesc: 'Google Research\'s universal world simulator. Learns from diverse data sources to simulate any environment — from kitchens to highways — in a unified framework.',
    gaia1: 'GAIA-1',
    gaia1Desc: 'Wayve\'s generative world model for autonomous driving, trained on London street data. Predicts realistic driving scenarios and generates novel traffic situations.',
    genesis: 'Genesis',
    genesisDesc: 'Physics engine combined with generative AI. Runs simulations up to 430,000x faster than real-time with physically accurate dynamics for robotics training.',
    dreamerV3: 'DreamerV3',
    dreamerV3Desc: 'A general-purpose world model that learns to act in any environment by "dreaming" — imagining future scenarios in latent space and training policies on those imagined experiences.',
    useCases: 'Use Cases',
    ...
    industrialSim: 'Industrial Simulation',
    industrialSimDesc: 'Optimizing manufacturing processes, warehouse logistics, and supply chains in digital twin environments.',
    gameWorlds: 'Game World Generation',
    gameWorldsDesc: 'Procedurally creating interactive game environments with realistic physics and consistent object behavior.',
    ...
    dataHunger: 'Data Requirements',
    dataHungerDesc: 'High-quality video data with diverse scenarios, camera angles, and physical interactions is scarce and expensive to collect at scale.',
    evaluation: 'Evaluation Metrics',
    evaluationDesc: 'How do you measure if a world model "understands" physics? Standard metrics like FID don\'t capture physical plausibility well.',
    futureTitle: 'The Future of World Models',
    futureDesc: 'World Models are evolving rapidly. Here are the key trends shaping the next generation:',
    futureMultimodal: 'Multimodal World Models',
    futureMultimodalDesc: 'Combining vision, language, audio, and tactile sensing into unified world representations.',
    futureComposable: 'Composable World Models',
    futureComposableDesc: 'Building complex environments by combining smaller, specialized models — like LEGO blocks for world simulation.',
    futureFoundation: 'Foundation World Models',
    futureFoundationDesc: 'Pre-trained on massive video data, then fine-tuned for specific domains — like GPT but for physical understanding.',
    futureLLMIntegration: 'LLM + World Model Fusion',
    futureLLMIntegrationDesc: 'Combining language understanding with physical reasoning — enabling AI that can both think and act in the real world.',
    keyTakeaways: 'Key Takeaways',
    ...
    takeaway3: 'The architecture follows a pipeline: Sensor Input → Encoder → Latent World → Decoder → Prediction',
    ...
    takeaway6: 'The future lies in foundation world models that combine physical understanding with language reasoning',
  },
