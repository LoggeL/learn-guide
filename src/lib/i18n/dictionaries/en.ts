export const en = {
  ...
  tierList: {
    ...
    kimiK25: 'Kimi K2.5',
    kimiK25Desc: 'Great visual understanding and swarm capabilities. Strong multimodal contender.',
    claudeSonnet46: 'Claude Sonnet 4.6',
    claudeSonnet46Desc: 'Smart with remarkably low hallucination rates. Reliable everyday model.',
    qwen35_35bA3b: 'Qwen 3.5 35B-A3B',
    qwen35_35bA3bDesc: 'MoE with only 3B active parameters — blazing fast inference with intelligence far above its compute cost. Self-hostable on 24GB GPUs.',
    qwen35_27b: 'Qwen 3.5 27B',
    qwen35_27bDesc: 'Dense model punching way above its weight. Benchmarks on par with DeepSeek 3.2 at a fraction of the size.',
    ...
    glm51: 'GLM 5.1',
    glm51Desc: 'Superintelligence at budget pricing. Top-tier reasoning and agent capabilities for a fraction of the cost.',
    qwen35: 'Qwen 3.5',
    grok420: 'Grok 4.20',
