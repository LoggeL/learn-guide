export const en = {
  ...
  tierList: {
    ...
    claudeOpus48Desc: 'Still the deep-work king. The safe fallback when Fable 5 refuses. Expensive but worth it for hard reasoning and emotional interpretation.',
    gpt54: 'GPT-5.4',
    gpt54Desc: 'Still excellent: 1M context, 33% fewer hallucinations than 5.2, Tool Search system. Now A-tier after GPT-5.5 took the top slot.',
    ...
    claudeOpus47Desc: 'If you got the money, this is still the deep-work king. Expensive, careful, and absurdly strong on hard reasoning.',
    gemini3Flash: 'Gemini 3.5 Flash',
    gemini3FlashDesc: 'Very capable and incredibly fast. The steep price jump over the earlier Flash model makes it much more expensive, so GPT-5.5 still beats it in many workflows.',
    deepseekV4: 'DeepSeek 4',
    deepseekV4Desc: 'New A-tier DeepSeek pick: strong reasoning and value, replacing the older 3.2 slot.',
    minimax27: 'MiniMax M2.7',
    minimax27Desc: 'Self-evolving architecture. SWE-Pro 56%, outstanding value via OpenRouter. S-tier coding & reasoning — exceptional across the board.',
    kimiK26: 'Kimi 2.6',
    kimiK26Desc: 'Great agent, great visual understanding. One of the strongest all-rounder multimodal models right now.',
    qwen36_27bA3: 'Qwen 3.6 27B-A3',
    qwen36_27bA3Desc: 'Ridiculously good for the size. Fast, cheap to run, and strong enough to deserve A-tier locally.',
    glm47Flash: 'GLM 4.7 Flash',
    glm47FlashDesc: 'Can be self-hosted on consumer GPUs. Impressive performance for its size.',
    gemini31Pro: 'Gemini 3.1 Pro',
    gemini31ProDesc: 'Benchmaxxed disappointment. Tops leaderboards but falls apart in real agent workflows. Google, how?',
    qwen3Next80b: 'Qwen3-Next 80B',
    qwen3Next80bDesc: 'Hybrid attention MoE with speculative decoding. 80B total but only 3B active — runs on consumer GPUs.',
    glm51: 'GLM 5.1',
    glm51Desc: 'Opus-tier vibes for about 10% of the price. Top-tier reasoning and agent capabilities with absurd economics.',
    qwen35: 'Qwen 3.5',
    grok420: 'Grok 4.20',
    grok420Desc: 'Still unclear what it\'s actually good at. Questionable value proposition.',
