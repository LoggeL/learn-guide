export const en = {
  ...
  topicDescriptions: {
    ...
    'tier-list': "Dated personal model rankings, favorites and experiences.",
  ...
  tierList: {
    ...
    sPlusTierDesc: 'Logge’s unrivaled favorite',
  ...
  vramCalc: {
    ...
    modelNotesDesc: "Personal preferences and dated rankings, with favourites and practical notes in one place.",
    modelNotesDate: "Ranking snapshot: 22 August 2026. Notes consolidated: 13 September 2026. This is not a live availability or benchmark tracker.",
    favouriteHeading: "The favourites",
    favouriteFable: "Fable 5 is Logge's favourite for demanding work. That preference is retained here as a personal assessment of this version.",
    favouriteSol: "GPT-5.6 Sol is Logge's practical everyday choice for demanding coding, agent work and infrastructure tasks. It remains in A tier in the ranking below.",
    historicalAvailability: "The earlier notes, dated 23 June 2026, described Fable 5 as unavailable. Availability must be checked for the exact version; the provider's live Fable page can describe a successor. The ranking records a preference, not a promise of current access.",
