export const en = {
  ...
  rag: {
    ...
    caseExplanation1: 'For simple factual queries, Traditional RAG is more efficient. The answer exists in a single document, so the direct retrieve-then-generate pipeline works perfectly. Agentic RAG would reach the same answer but with unnecessary overhead from planning and evaluation steps.',
    ...
    caseExplanation3: 'Neither approach can answer questions about future events or information not in the knowledge base. Traditional RAG may hallucinate an answer from superficially related content. Agentic RAG might search more thoroughly before admitting defeat, but the fundamental limitation is the same: no amount of retrieval helps when the data doesn\'t exist.',
    caseResult1Traditional: 'Retrieved return policy document directly. Response accurate and fast.',
    caseResult1Agentic: 'Same accurate answer, but took longer due to unnecessary reasoning steps.',
    caseResult2Traditional: 'Retrieved partial data from one source. Missing competitor context, incomplete comparison.',
    caseResult2Agentic: 'Decomposed query, retrieved from multiple sources, synthesized complete comparison.',
    caseResult3Traditional: 'Hallucinated an answer based on past stock data. Confident but wrong.',
    caseResult3Agentic: 'Searched extensively, found no relevant data, acknowledged uncertainty—but still no answer.',
    outcomeSuccess: 'Success',
    outcomePartial: 'Partial / Incomplete',
    outcomeFailure: 'Failed',
    legendSuccess: 'Successful step',
    legendPartial: 'Partial result',
    legendFailure: 'Failed / No data',
