export const en = {
  ...
  evaluation: {
    ...
    // Benchmarks Section
    benchmarksSection: 'Common Benchmarks',
    benchmarksSectionDesc: 'Standardized benchmarks help compare models and track progress. Different benchmarks measure different capabilities.',
    benchmarkMmlu: 'MMLU (Massive Multitask Language Understanding)',
    benchmarkMmluDesc: '57 subjects from STEM to humanities. Tests broad knowledge and reasoning. Scores range from 25% (random) to 90%+ for frontier models.',
    benchmarkHellaswag: 'HellaSwag',
    benchmarkHellaswagDesc: 'Common sense reasoning about everyday situations. Tests whether models understand how scenarios typically unfold.',
    benchmarkHumaneval: 'HumanEval',
    benchmarkHumanevalDesc: 'Code generation benchmark with 164 Python programming problems. Measures functional correctness of generated code.',
    benchmarkGsm8k: 'GSM8K',
    benchmarkGsm8kDesc: 'Grade school math word problems. Tests multi-step mathematical reasoning. Key benchmark for reasoning capabilities.',
    benchmarkArc: 'ARC (AI2 Reasoning Challenge)',
    benchmarkArcDesc: 'Science questions from standardized tests. ARC-Easy and ARC-Challenge variants test different difficulty levels.',
    benchmarkMath: 'MATH',
    benchmarkMathDesc: 'Competition mathematics problems. Significantly harder than GSM8K, requiring advanced mathematical reasoning.',
    benchmarkCaveats: 'Benchmark Caveats',
    benchmarkCaveat1: 'Data contamination: Training data may include benchmark questions',
    benchmarkCaveat2: 'Overfitting to benchmarks: Models optimized for specific tests may not generalize',
    benchmarkCaveat3: 'Limited scope: Benchmarks test narrow capabilities, not real-world usefulness',
    benchmarkCaveat4: 'Static nature: Benchmarks don\'t evolve as capabilities improve',

    // LLM as a Judge Section
    llmJudge: 'LLM as a Judge',
    llmJudgeDesc: 'Using LLMs to evaluate other LLM outputs is increasingly common. A powerful technique, but with important limitations.',
    llmJudgeWhat: 'How It Works',
    llmJudgeWhatDesc: 'A separate LLM (the "judge") is prompted to evaluate outputs from the model being tested. The judge scores responses on criteria like helpfulness, accuracy, or safety.',
    llmJudgeAdvantages: 'Advantages',
    llmJudgeAdv1: 'Scalability',
    llmJudgeAdv1Desc: 'Can evaluate thousands of outputs automatically, far faster than human review.',
    llmJudgeAdv2: 'Consistency',
    llmJudgeAdv2Desc: 'Same judge model applies consistent criteria across all evaluations (no evaluator fatigue).',
    llmJudgeAdv3: 'Cost-effective',
    llmJudgeAdv3Desc: 'Much cheaper than hiring human evaluators for large-scale testing.',
    llmJudgeAdv4: 'Nuanced Assessment',
    llmJudgeAdv4Desc: 'Can evaluate subjective qualities like tone, style, and helpfulness that are hard to capture with metrics.',
    llmJudgeProblems: 'Problems & Limitations',
    llmJudgeProb1: 'Self-preference Bias',
    llmJudgeProb1Desc: 'LLMs tend to prefer outputs similar to their own style. GPT-4 as a judge favors GPT-4 outputs.',
    llmJudgeProb2: 'Position Bias',
    llmJudgeProb2Desc: 'Judges often favor the first or last response in a comparison, regardless of quality.',
    llmJudgeProb3: 'Verbosity Bias',
    llmJudgeProb3Desc: 'Longer responses are often rated higher, even when brevity would be better.',
    llmJudgeProb4: 'Sycophancy',
    llmJudgeProb4Desc: 'Judge models may rate confident-sounding answers higher, even if incorrect.',
    llmJudgeProb5: 'Ceiling Effect',
    llmJudgeProb5Desc: 'A judge can\'t reliably evaluate outputs that exceed its own capabilities.',
    llmJudgeBestPractices: 'Best Practices for LLM Judges',
    llmJudgePractice1: 'Use a stronger model as judge than the model being evaluated',
    llmJudgePractice2: 'Randomize response order to mitigate position bias',
    llmJudgePractice3: 'Calibrate with human evaluations on a subset of data',
    llmJudgePractice4: 'Use multiple judges and aggregate scores',
    llmJudgePractice5: 'Be explicit about evaluation criteria in the judge prompt',
    ...
    takeaway4: 'LLM-as-a-judge scales well but has systematic biases—calibrate with humans',
    takeaway5: 'Benchmarks are useful for comparison but don\'t capture real-world performance',
  },
