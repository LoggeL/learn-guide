export const en = {
  ...
  kvCache: {
    ...
    turboQuantDesc: 'Google\'s newer KV-compression line attacks a different bottleneck: not just how many KV vectors you store, but how aggressively you can compress each vector without wrecking attention quality. TurboQuant combines two ideas: a strong quantizer for the main signal, then a tiny extra correction step to cancel the remaining error.',
    polarQuantTitle: 'PolarQuant',
    polarQuantDesc: 'Randomly rotates vectors before quantization so the geometry becomes easier to compress well. Most of the available bits go here.',
    qjlTitle: 'QJL',
    qjlDesc: 'Quantized Johnson-Lindenstrauss adds a tiny low-bit correction for the residual error, reducing bias in the resulting attention scores.',
    whyNewTitle: 'Why it matters',
    whyNewDesc: 'This is interesting for KV cache compression because the real enemy is memory overhead. TurboQuant claims extreme compression with little or no quality loss, which could matter a lot for long-context inference.',
    keyTakeaways: 'Key Takeaways',
