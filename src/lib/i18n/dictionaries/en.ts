export const en = {
  ...
  tierList: {
    ...
    gemini31ProDesc: 'Great world knowledge but struggles with tool use and function calling.',
    ...
    gptOss20bDesc: 'OpenAI\'s open-source entry. Strong coding model for consumer self-hosting.',
    glm5: 'GLM 5',
    glm5Desc: 'Good agent capabilities with low hallucination rates. Solid all-rounder.',
    qwen35: 'Qwen 3.5',
    qwen35Desc: 'Strong open-weight option with broad capabilities.',
    grok41: 'Grok 4.1',
    grok41Desc: 'Still unclear what it\'s actually good at. Questionable value proposition.',
