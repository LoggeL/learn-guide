export const en = {
  ...
  tierList: {
    ...
    dTier: 'D-Tier',
    dTierDesc: 'Avoid — better alternatives exist',
    claudeOpus46: 'Claude Opus 4.6',
    claudeOpus46Desc: 'The best overall model. Unmatched in coding, reasoning, and nuanced instruction following.',
    kimi: 'Kimi',
    kimiDesc: 'Outstanding reasoning and creative capabilities. A genuine S-tier contender.',
    claudeSonnet46: 'Claude Sonnet 4.6',
    claudeSonnet46Desc: 'Excellent balance of quality and speed. Great for everyday use.',
    deepseekV32: 'DeepSeek V3.2',
    deepseekV32Desc: 'Strong open-weight model with impressive coding and reasoning.',
    minimax25: 'MiniMax 2.5',
    minimax25Desc: 'Surprisingly capable for its size. Good multilingual support.',
    glm5: 'GLM 5',
    glm5Desc: 'Solid Chinese-origin model with good general performance.',
    qwen35: 'Qwen 3.5',
    qwen35Desc: 'Strong open-weight option with broad capabilities.',
    llama4Maverick: 'Llama 4 Maverick',
    llama4MaverickDesc: 'Meta\'s latest open model. Good but not exceptional.',
    claudeHaiku45: 'Claude Haiku 4.5',
    claudeHaiku45Desc: 'Fast and cheap. Great for simple tasks and high-volume use.',
    gpt5Mini: 'GPT-5 mini',
    gpt5MiniDesc: 'Decent small model. Solid baseline performance.',
    gpt52: 'GPT-5.2',
    gpt52Desc: 'Turbo Yapper — overly verbose and loves to pad responses unnecessarily.',
    gemini31Pro: 'Gemini 3.1 Pro',
    gemini31ProDesc: 'Benchmark Fraud — scores well on benchmarks but underwhelms in real usage.',
    grok4: 'Grok 4',
    grok4Desc: 'Overtuned — feels like it was optimized for benchmarks over real conversations.',
    grok4Heavy: 'Grok 4 Heavy',
    grok4HeavyDesc: 'Way too expensive for what it delivers. Not worth the premium.',
    claudeOpus45: 'Claude Opus 4.5',
    claudeOpus45Desc: 'Superseded by Opus 4.6. No reason to use the older version.',
  },
}
