export const en = {
  ...
  moe: {
    ...
    vizLoaded: 'loaded',
    vizActive: 'active',
    vizAllExperts: 'All 8 experts in memory',
    vizMemoryFootprint: '100% memory footprint',
    vizCannotOffload: 'Cannot offload inactive experts',
    vizInputTokens: 'Input Tokens',
    vizRouter: 'Router Network',
    vizSelectsTop2: 'Selects top-2 experts per token',
    vizClickRun: 'Click "Route Tokens" to see how different tokens are routed to specialized experts',
    vizRouting: 'Routing',
    vizProcessing: 'Processing with',
    vizComplete: 'All tokens processed! Notice all experts stayed loaded.',
    vizActiveNow: 'Active (processing)',
    vizLoadedIdle: 'Loaded but idle',
    ...
    vizMath: 'Mathematics',
    vizCode: 'Code',
    vizLanguage: 'Language',
    vizReasoning: 'Reasoning',
    vizCreative: 'Creative',
    vizFactual: 'Factual',
    vizScience: 'Science',
    vizGeneral: 'General',
    vizToken1: 'Calculate',
