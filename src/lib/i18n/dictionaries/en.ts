export const en = {
  ...
  worldModels: {
    title: 'World Models',
    description: 'AI systems that learn an internal representation of the physical world.',
    whatIs: 'What are World Models?',
    whatIsDesc: 'World Models are AI systems that learn an internal representation of the physical world to predict and simulate the future. They understand physics, object motion, and causal relationships.',
    whatIsDesc2: 'Instead of just learning pixel patterns, World Models develop a deeper understanding of how the world works—similar to how humans build mental models of reality.',
    howTheyWork: 'How do they work?',
    howTheyWorkDesc: 'World Models combine various techniques to model physical reality:',
    latentSpace: 'Latent Space Representation',
    latentSpaceDesc: 'Compressing high-dimensional sensor data (e.g., video) into a compact latent space that captures the essence of the scene.',
    videoPrediction: 'Video Prediction',
    videoPredictionDesc: 'Predicting future frames based on past observations and planned actions.',
    physicsAware: 'Physics-Aware Training',
    physicsAwareDesc: 'Training with physical constraints or simulators so the model learns realistic motion and interactions.',
    diffusion: 'Diffusion-Based Approaches',
    diffusionDesc: 'Using diffusion models to generate consistent, physically plausible future predictions.',
    whyNeeded: 'Why do we need them?',
    slowExpensive: 'Reality is slow and expensive',
    slowExpensiveDesc: 'Training robots in the real world is time-consuming, costly, and potentially dangerous. A single mistake can destroy hardware or endanger people.',
    parallelTraining: 'Parallelized training in simulation',
    parallelTrainingDesc: 'World Models enable training thousands of virtual agents simultaneously, gathering millions of hours of experience in mere hours.',
    physicsUnderstanding: 'Text-based LLMs don\'t really understand physics',
    physicsUnderstandingDesc: 'Language models can talk about physics but don\'t truly understand spatial relationships, momentum, or gravity. World Models learn these concepts through experience.',
    examples: 'Examples',
    nvidiaCosmos: 'NVIDIA Cosmos',
    nvidiaCosmosDesc: 'Physical AI platform for robotics and autonomous driving. Generates synthetic training data and simulates complex driving scenarios.',
    googleGenie: 'Google Genie 2',
    googleGenieDesc: 'Generates interactive, playable 3D worlds from text descriptions or images. Can create consistent environments with realistic physics.',
    genesis: 'Genesis',
    genesisDesc: 'Physics engine combined with generative AI. Enables ultra-fast, physically accurate simulations for robotics training.',
    others: 'Other Models',
    othersDesc: 'UniSim (universal world simulation), GAIA-1 by Wayve (autonomous driving), and many research projects in embodied AI.',
    useCases: 'Use Cases',
    autonomousDriving: 'Autonomous Driving',
    autonomousDrivingDesc: 'The largest current application area. World Models simulate traffic scenarios, test edge cases, and train vehicle policies without real-world road testing.',
    robotics: 'Robotics Training',
    roboticsDesc: 'Training manipulation and navigation skills in simulation before transferring policies to real robots.',
    videoGeneration: 'Video Generation',
    videoGenerationDesc: 'As a "byproduct," World Models can also be used to generate realistic videos—though that\'s not their primary purpose.',
    challenges: 'Challenges',
    challengesDesc: 'Despite the potential, there are significant hurdles:',
    computeIntensive: 'Extremely resource-intensive',
    computeIntensiveDesc: 'Training requires enormous compute power and massive datasets. Only a few companies can afford these models.',
    simToReal: 'Sim-to-Real Gap',
    simToRealDesc: 'What works in simulation sometimes fails in reality. Transfer remains a challenge.',
    generalization: 'Generalization',
    generalizationDesc: 'World Models can overfit to unseen scenarios. Robust generalization is still an open problem.',
    keyTakeaways: 'Key Takeaways',
    takeaway1: 'World Models learn internal representations of the physical world for prediction and simulation',
    takeaway2: 'They enable massively parallelized training in virtual environments instead of slow real-time interaction',
    takeaway3: 'Autonomous driving is currently the biggest application area, but robotics is catching up',
    takeaway4: 'Training is extremely compute-intensive—only a few players can afford high-quality World Models',
    takeaway5: 'Sim-to-real transfer and generalization remain central research challenges',
  },
