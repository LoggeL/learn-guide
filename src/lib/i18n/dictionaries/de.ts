...
export const de: Dictionary = {
  ...
  topicNames: {
    ...
    'multi-head-attention-kv-cache': 'Multi-Head Attention & KV-Cache',
  ...
  topicDescriptions: {
    ...
    'multi-head-attention-kv-cache': 'Wie Attention-Heads gelernte Projektionen parallel ausführen und warum der KV-Cache wichtig ist.',
  ...
  vision: {
    ...
    tokenCostsDesc: 'Bilder sind teür in Bezug auf Tokens. Das Verständnis davon hilft dir, deine Anwendungen zu optimieren.',
    ...
    multimodalDesc: 'Das Modell lernt, visuelle und textülle Repräsentationen auszurichten, was Aufgaben wie Bildbeschriftung, visuelle Fragen und Dokumentenverständnis ermöglicht.',
    keyTakeaways: 'Wichtige Erkenntnisse',
  ...
  agentProblems: {
    ...
    costLatencyDesc: 'Jeder Schritt im Agentenzyklus erfordert einen vollständigen LLM-Inferenzaufruf. Mehrstufige Aufgaben können schnell teür und langsam werden.',
  ...
  diffusionFundamentals: {
    ...
    description: 'Baü Intuition für Vorwärtskorruption, Rückwärts-Entrauschen, Scheduler und scorebasiertes Lernen auf.',
    ...
    interactiveDesc: 'Passe Rauschen manüll an oder nutze Vorwärts-/Rückwärts-Autoplay, um zu sehen, wie Struktur verschwindet und wieder erscheint.',
    keyTakeaways: 'Wichtige Erkenntnisse',
  ...
  imageDiffusion: {
    ...
    cfgDesc: 'CFG mischt konditionierte und unkonditionierte Vorhersagen. Höhere Guidance stärkt Prompttreü, kann aber Vielfalt reduzieren und Artefakte verstärken.',
  ...
  rag: {
    ...
    metricFaithfulness: 'Treü (Faithfulness)',
    ...
    metricRelevanceDesc: 'Adressiert die Antwort tatsächlich die gestellte Frage? Eine treü Antwort kann immer noch irrelevant sein, wenn sie das Thema verfehlt.',
  ...
  memorySystems: {
    ...
    longTermDesc: 'Daürhafte Speicherung vergangener Interaktionen, Fakten und gelernter Präferenzen.',
    ...
    entityRelationsDesc: 'Extrahiere Entitäten (Personen, Projekte, Konzepte) und ihre Beziehungen aus Gesprächen und baü einen abfragbaren Wissensgraphen.',
  ...
  worldModels: {
    ...
    slowExpensive: 'Realität ist langsam & teür',
    ...
    parallelTrainingDesc: 'World Models ermöglichen das Training tausender virtüller Agenten gleichzeitig, die Millionen von Stunden Erfahrung in Stunden sammeln. Was ein Roboter in 1 Jahr real lernt, schafft die Simulation in 1 Stunde.',
  ...
  llmTraining: {
    ...
    stage4Desc: 'Das Basismodell auf Billionen von Tokens mit Next-Token-Prediction-Ziel trainieren. Dies ist die teürste und rechenintensivste Stufe.',
  ...
  trainingData: {
    ...
    controversialSourcesDesc: 'Die Nachfrage nach Trainingsdaten hat Unternehmen in rechtlich und ethisch graü Bereiche geführt. Mehrere aufsehenerregende Klagen und Kontroversen haben die Debatte geprägt.',
    ...
    syntheticScalingWhen: 'Wann synthetische Daten helfen: domänenspezifische Aufgaben (Mathematik, Code, Denken), wenn echte Daten knapp oder teür sind, für Alignment- und Sicherheitstraining, wenn Vielfalt der Trainingsszenarien wichtig ist.',
    ...
    takeaway7: 'Wir stoßen möglicherweise an eine "Datenmaür" für Text, was das Feld zu multimodalen Daten und synthetischer Erzeugung drängt.',
  ...
  responsibleAi: {
    ...
    nistDesc: 'Ein freiwilliges Rahmenwerk des U.S. National Institute of Standards and Technology zur Steürung von KI-Risiken während des gesamten KI-Lebenszyklus.',
    nistGovern: 'Govern',
  ...
  lora: {
    ...
    problemDesc: 'Bei einem 70B-Parameter-Modell bedeutet das, 70 Milliarden Gewichte zu speichern und zu aktualisieren. Du brauchst eine vollständige Kopie des Modells im Speicher, plus Optimizer-Zustände (2-3x die Modellgröße). Das sind Hunderte Gigabyte VRAM — teür, langsam und für die meisten Teams unpraktisch.',
  ...
  gettingStarted: {
    ...
    breakdownModelHint: 'Das genau Modell, das deine Anfrage verarbeitet hat.',
    ...
    understandModel: 'Das genau Modell, das deine Anfrage verarbeitet hat. Einige Anbieter können an verschiedene Versionen weiterleiten.',
  ...
  learningPath: {
    ...
    lpMemory: 'Agents ein daürhaftes Gedächtnis über Gespräche hinweg geben',
  ...
  tierList: {
    ...
    gemini3FlashDesc: 'Sehr capable und unglaublich schnell. Der starke Preissprung gegenüber dem früheren Flash-Modell macht es aber deutlich teurer, sodass GPT-5.5 es in vielen Workflows aussticht.',
    ...
    gemini31ProDesc: 'Benchmaxxed-Enttäuschung. Toppt Leaderboards, versagt aber in echten Agent-Workflows. Google, wie nur?',
