...
export const de: Dictionary = {
  ...
  localInference: {
    ...
    moeDesc: 'Mixture-of-Experts-Modelle (MoE) sind ein Gamechanger für lokale Inferenz. Statt jeden Parameter pro Token zu aktivieren, leitet MoE jeden Token nur durch eine kleine Teilmenge von "Experten"-Schichten — so erhältst du die Intelligenz eines riesigen Modells zu einem Bruchteil der Kosten.',
    moeBenefit1: 'Nur ein Bruchteil aktiv',
    moeBenefit1Desc: 'Pro Token feuert nur eine kleine Teilmenge der Experten. Ein 80B-MoE-Modell aktiviert vielleicht nur 3B Parameter — Inferenzgeschwindigkeit und Speicher verhalten sich wie ein 3B-Modell.',
    moeBenefit2: 'Intelligenz großer Modelle',
    moeBenefit2Desc: 'Die vollen 80B Parameter speichern Wissen über alle Experten. Du bekommst die Reasoning-Tiefe eines viel größeren Modells, nur sparsam abgerufen.',
    moeBenefit3: 'Perfekt bei wenig VRAM',
    moeBenefit3Desc: 'Auch wenn alle Parameter geladen werden müssen, passen quantisierte MoE-Modelle in erstaunlich wenig VRAM — und Inferenz ist schnell, weil nur aktive Parameter Rechenzeit brauchen.',
    ...
    moeSweetSpot: '✨ Sweet Spot',
    moeInsightLabel: 'Die Erkenntnis:',
    moeInsight: 'Qwen MoE aktiviert nur 3B seiner 80B Parameter pro Token — das liefert dir 70B-Klasse-Intelligenz bei 3B-Klasse-Geschwindigkeit und passt bequem in 12 GB VRAM.',
