...
export const de: Dictionary = {
  ...
  rag: {
    ...
    caseRun: 'Vergleich starten',
    caseReset: 'Zurücksetzen',
    ...
    caseExplanation1: 'Für einfache Faktenanfragen ist traditionelles RAG effizienter. Die Antwort existiert in einem einzigen Dokument, sodass die direkte Abruf-dann-Generierung-Pipeline perfekt funktioniert. Agentic RAG würde zur gleichen Antwort kommen, aber mit unnötigem Overhead durch Planungs- und Bewertungsschritte.',
    ...
    caseExplanation3: 'Keiner der Ansätze kann Fragen über zukünftige Ereignisse oder Informationen beantworten, die nicht in der Wissensbasis sind. Traditionelles RAG könnte eine Antwort aus oberflächlich verwandten Inhalten halluzinieren. Agentic RAG sucht vielleicht gründlicher, bevor es aufgibt, aber die grundlegende Einschränkung ist dieselbe: Kein Abruf hilft, wenn die Daten nicht existieren.',
    caseResult1Traditional: 'Rückgaberichtlinie-Dokument direkt abgerufen. Antwort genau und schnell.',
    caseResult1Agentic: 'Gleiche genaue Antwort, aber länger gedauert durch unnötige Reasoning-Schritte.',
    caseResult2Traditional: 'Teilweise Daten aus einer Quelle abgerufen. Fehlender Konkurrenzkontext, unvollständiger Vergleich.',
    caseResult2Agentic: 'Anfrage zerlegt, aus mehreren Quellen abgerufen, vollständigen Vergleich synthetisiert.',
    caseResult3Traditional: 'Antwort basierend auf vergangenen Aktiendaten halluziniert. Selbstsicher aber falsch.',
    caseResult3Agentic: 'Umfangreich gesucht, keine relevanten Daten gefunden, Unsicherheit eingestanden—aber trotzdem keine Antwort.',
    outcomeSuccess: 'Erfolgreich',
    outcomePartial: 'Teilweise / Unvollständig',
    outcomeFailure: 'Fehlgeschlagen',
    legendSuccess: 'Erfolgreicher Schritt',
    legendPartial: 'Teilergebnis',
    legendFailure: 'Fehlgeschlagen / Keine Daten',
