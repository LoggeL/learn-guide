...
export const de: Dictionary = {
  ...
  common: {
    ...
    helpMakeThisBetterDesc: 'Dieser Guide ist Open Source. Hast du eine Idee für ein neüs Thema? Einen Fehler gefunden? Eine Erklärung verbessern? Jeder Beitrag hilft.',
  ...
  topicDescriptions: {
    ...
    'training-data': 'Woher KI-Modelle ihr Wissen beziehen: legitime Qüllen, Kontroversen und synthetische Daten',
    ...
    'kv-cache': 'Berechnete Keys und Valüs speichern, um Arbeit zu sparen',
  ...
  contextRot: {
    ...
    whyHappensDesc: 'LLMs haben begrenzte Kontextfenster und nutzen Aufmerksamkeitsmechanismen, die den Fokus auf alle Tokens verteilen müssen. Bei längeren Gesprächen konkurrieren frühere Informationen mit neürem Inhalt um die begrenzte Aufmerksamkeitskapazität des Modells.',
    // Reasons
    reason1Title: 'Begrenzte Kontextfenster',
    reason1Desc: 'LLMs haben begrenzte Kontextfenster und nutzen Aufmerksamkeitsmechanismen, die den Fokus auf alle Tokens verteilen müssen. Bei längeren Gesprächen konkurrieren frühere Informationen mit neürem Inhalt um die begrenzte Aufmerksamkeitskapazität des Modells.',
    ...
    reason3Desc: 'Transformer neigen dazu, neüre Tokens stärker zu gewichten. Anweisungen am Anfang werden natürlich weniger einflussreich.',
    ...
    position4Desc: 'Teile bei sehr langen Kontexten den Inhalt in kleinere Chunks und verarbeite sie seqüntiell. Aggregiere Ergebnisse, anstatt dich auf eine einzige Langkontext-Verarbeitung zu verlassen.',
  },
  ...
  attention: {
    ...
    howWorksDesc: 'Für jede Position berechnet das Modell Qüry-, Key- und Valü-Vektoren. Aufmerksamkeits-Scores werden durch Vergleich von Qüries mit Keys berechnet und dann verwendet, um eine gewichtete Summe der Valüs zu erstellen.',
    ...
    // QKV section
    qkvTitle: 'Die drei Schlüssel: Qüry, Key und Valü',
    queryTitle: 'Qüry',
    queryDesc: '"Wonach suche ich?" - Repräsentiert das aktülle Wort, das Kontext sucht.',
    keyTitle: 'Key',
    keyDesc: '"Was enthalte ich?" - Ein Label für jedes Wort in der Seqünz zur Überprüfung gegen die Qüry.',
    valueTitle: 'Valü',
    valueDesc: '"Welche Information biete ich?" - Der tatsächliche Inhalt, der weitergegeben wird, wenn Qüry und Key übereinstimmen.',
    ...
    mqaDesc: 'Anstatt separate Key- und Valü-Köpfe für jeden Qüry-Kopf zu haben, teilen sich alle Qüry-Köpfe ein einzelnes K und V. Reduziert die KV-Cache-Größe drastisch und beschleunigt die Inferenz auf Kosten etwas geringerer Qualität.',
    gqaDesc: 'Ein Mittelweg zwischen Standard Multi-Head Attention und MQA. Gruppen von Qüry-Köpfen teilen sich K/V-Köpfe. Erhält den Großteil der Qualität bei reduziertem Speicherbedarf.',
  ...
  transformerArchitecture: {
    ...
    layer_multi_head_attention_desc: 'Der Kernmechanismus. Jeder Head berechnet Qüry-, Key- und Valü-Projektionen und bestimmt Attention-Scores. Mehrere Heads erfassen verschiedene Beziehungstypen (Syntax, Semantik, Koreferenz) gleichzeitig.',
    ...
    takeaway2: 'Sein Attention-Mechanismus erfasst weitreichende Abhängigkeiten, mit denen seqüntielle Modelle kämpften',
  ...
  vision: {
    ...
    takeaway4: 'Die Kombination von Bild und Sprache ermöglicht leistungsstarke neü Anwendungen',
  },
  ...
  agentSecurity: {
    ...
    a2aType3Desc: 'Ausnutzung, dass Agenten Nachrichten von Peer-Agenten oft mehr vertraün als externen Qüllen, um Sicherheitsfilter zu umgehen.',
    ...
    framework1Point3: 'Manage: Kontrollen implementieren und auf neü Risiken überwachen',
    framework2Tag: 'OWASP',
  ...
  agenticPatterns: {
    ...
    pattern2Desc: 'Erstelle zürst einen übergeordneten Plan, dann führe die Schritte seqüntiell aus.',
    ...
    planStep3: 'Neuplanung erfolgt, wenn die Ausführung fehlschlägt oder neü Infos auftauchen',
  ...
  mcp: {
    ...
    primitiveToolsExample: 'qüry_database, send_email, create_file',
    ...
    serverGithub: 'GitHub',
    serverGithubDesc: 'Repository-Verwaltung, Issüs, Pull Reqüsts und Code-Suche. Erfordert einen persönlichen Zugriffstoken.',
    serverSlack: 'Slack',
  ...
  interactive: {
    ...
    contextFillingDesc: 'Deine Systemanweisung verliert an Einfluss, da neüre Nachrichten Vorrang haben. Beachte, wie sie visüll verblasst – dies stellt die schwindende Aufmerksamkeit des Modells dar.',
    ...
    diffusionAutoplayHint: 'Diffusionsmodelle lernen, den Rauschprozess umzukehren. Beim Training sieht das Modell Bilder auf jeder Rauschstufe und lernt, die saubere Version vorherzusagen. Bei der Generierung startet es mit reinem Rauschen und entrauscht schrittweise — erzeugt ein neüs Bild aus dem Nichts.',
    ...
    textDiffusionNextSentence: 'Neür Satz',
    ...
    textDiffusionInsightPoint1: 'Alle Positionen werden gleichzeitig vorhergesagt — das Modell sieht die ganze Seqünz auf einmal und füllt alle [MASK]-Tokens parallel aus.',
  ...
  diffusion: {
    ...
    textTrackDesc: 'Arbeitet auf maskierten Token-Seqünzen und verfeinert Token-Schätzungen iterativ mit denoising-ähnlichen Updates.',
  ...
  textDiffusion: {
    ...
    maskPredictDesc: 'Text-Diffusion startet oft mit stark maskierten Seqünzen und sagt fehlende Tokens wiederholt voraus. Konfidenzbasiertes Remasking und Verfeinerung verbessern häufig die Kohärenz.',
    ...
    paddingTokensDesc: 'Gebatchte Diffusion verwendet oft feste Seqünzlängen. [PAD]-Tokens füllen ungenutzte Positionen, und Attention-Masks verhindern Einfluss auf Inhalts-Tokens.',
  ...
  rag: {
    ...
    case2TradDoc1: '[finanzen/q3-2024.md] "Q3 2024 Umsatz: 4,2 Mio. € (+12% YoY). Haupttreiber: Enterprise-Vertriebswachstum, neü Produkteinführungen. Operative Marge: 18%."',
    case2TradResponse: 'Unser Q3 2024 Umsatz betrug 4,2 Mio. €, ein Plus von 12% im Jahresvergleich, getrieben durch Enterprise-Vertrieb und neü Produkte. (Hinweis: Ich habe keine Konkurrenzdaten für einen Vergleich.)',
    ...
    case2AgentDoc1: '[finanzen/q3-2024.md] "Q3 2024 Umsatz: 4,2 Mio. € (+12% YoY). Haupttreiber: Enterprise-Vertriebswachstum, neü Produkteinführungen. Operative Marge: 18%."',
  ...
  toolDesign: {
    ...
    principle1Desc: 'Verwende beschreibende, eindeutige Namen. "search_web" ist besser als "sw" oder "qüry".',
  ...
  orchestration: {
    ...
    orchestratorWorkerDesc: 'Ein zentraler Orchestrator verwaltet einen Pool von Worker-Agenten. Worker sind zustandslos und können dynamisch skaliert werden. Der Orchestrator übernimmt Aufgaben-Qüuing, Lastverteilung und Ergebnisaggregation.',
  ...
  evaluation: {
    ...
    benchmarkSweDesc: 'Echte GitHub-Issüs aus beliebten Python-Repos. Agenten müssen Kontext verstehen, Code schreiben und bestehende Tests bestehen.',
  ...
  training: {
    ...
    overfittingDesc: 'Das Modell merkt sich Trainingsdaten, versagt aber bei neün Daten.',
  ...
  worldModels: {
    ...
    latentDimInstruction: 'Ziehe die Regler, um zu sehen, wie jede latente Dimension ein komplexes visülles Konzept unabhängig steürt.',
    latentZ1: 'Tageszeit',
    ...
    physicsAwareDesc: 'Training mit physikalischen Constraints oder Physik-Simulatoren, damit das Modell realistische Bewegungen, Kollisionen, Schwerkraft und Materialinteraktionen lernt — nicht nur visülle Plausibilität.',
  ...
  llmTraining: {
    ...
    fineTuningDefDesc: 'Ein Modell an neü Aufgaben oder Domänen anpassen, indem auf aufgabenspezifischen Daten trainiert wird. Kann für jeden Zweck durchgeführt werden.',
    ...
    stage1Desc: 'Sammeln massiver Textkorpora aus vielfältigen Qüllen einschließlich Web-Crawls, Büchern, Code-Repositories und wissenschaftlichen Papers.',
    ...
    stage3Desc: 'Bereinigten Text in numerische Token-Seqünzen mit BPE, SentencePiece oder Unigram-Tokenizern konvertieren.',
    stage3Methods: 'BPE (GPT), SentencePiece (Llama), Unigram (T5)',
    stage3Vocab: 'Vokabulargröße: ~32K-100K Tokens',
    stage3Duration: '1-2 Wochen (Tokenizer trainieren, Korpus tokenisieren, Seqünzen packen)',
    ...
    takeaway6: 'Das Feld entwickelt sich schnell – neü Paradigmen wie reines RL verändern, wie wir über Training denken',
  },

  // Trainingsdaten-Seite
  trainingData: {
    title: 'Trainingsdaten',
    description: 'Woher KI-Modelle ihr Wissen beziehen: legitime Qüllen, Kontroversen und synthetische Daten.',
    ...
    // Legitime Quellen
    legitimateSources: 'Legitime Datenqüllen',
    legitimateSourcesDesc: 'Große LLM-Trainingsdatensätze schöpfen aus verschiedenen öffentlich zugänglichen und lizenzierten Qüllen. Der Umfang ist atemberaubend — moderne Modelle trainieren auf Billionen von Token.',
    ...
    sourcePileDesc: 'Ein 825GB kuratierter Datensatz aus 22 verschiedenen Qüllen: Wikipedia, PubMed, ArXiv, GitHub, StackExchange, USPTO-Patente und mehr. Für die Forschung konzipiert.',
    ...
    // Kontroverse Quellen
    controversialSources: 'Kontroverse & illegale Qüllen',
    ...
    syntheticDataDesc: 'Da natürliche Datenqüllen erschöpft und rechtlich umstritten werden, sind synthetische Daten — Trainingsdaten, die von KI-Modellen selbst erzeugt werden — zur Frontier des KI-Trainings geworden. Dies ist der sich am schnellsten entwickelnde Bereich bei KI-Daten.',

    syntheticWhat: 'Was sind synthetische Daten?',
    syntheticWhatDesc: 'Synthetische Daten sind Trainingsdaten, die von KI-Modellen erzeugt werden, anstatt aus menschlichen Qüllen gesammelt zu werden. Dies reicht von einfachen Umformulierungen bis zu komplexen mehrstufigen Argumentationsketten, die von Frontier-Modellen erzeugt werden. Die Schlüsselerkenntnis: KI-Modelle können Trainingsdaten erstellen, die oft höherwertiger sind als das, was Menschen produzieren würden, weil Modelle in großem Maßstab bei gleichbleibender Konsistenz generieren können.',
    ...
    syntheticScalingNot: 'Wann sie schaden: rekursives Selbsttraining ohne Qualitätskontrolle, wenn das Qüllmodell systematische Verzerrungen hat, für Aufgaben, die echtes Weltwissen erfordern, wenn als vollständiger Ersatz für echte Daten verwendet.',
    ...
    futureDesc: 'Die Landschaft der Trainingsdaten verändert sich rasant, getrieben durch rechtlichen Druck, Datenknappheit und neü multimodale Anforderungen.',
    ...
    futureLicensingDesc: 'Eine neü Industrie entsteht rund um lizenzierte Trainingsdaten. Verlage, Content-Ersteller und Datenhändler verhandeln Deals mit KI-Unternehmen. Reddits 60-Mio-$-Google-Deal war erst der Anfang.',
    ...
    takeaway3: 'Die rechtliche Landschaft entwickelt sich rasant — Klagen über urheberrechtlich geschützte Bücher, Nachrichtenartikel und kreative Werke schaffen neü Präzedenzfälle.',
    ...
    interactiveTitle: 'Datenqüllen-Explorer',
    interactiveDesc: 'Erkunde die wichtigsten Trainingsdatenqüllen, ihren Umfang und wie sie sich vergleichen.',
    ...
    interactiveAll: 'Alle Qüllen',
    interactiveTokens: 'Token',
    interactiveClickExplore: 'Klicke auf eine Qülle für Details',
  },
  ...
  nestedLearning: {
    ...
    description: 'Ein neür Ansatz, der KI Neüs lernen lässt, ohne Altes zu vergessen — durch gleichzeitiges Lernen mit verschiedenen Geschwindigkeiten.',
    ...
    problemDesc: 'Das ist das Kernproblem. Wenn du eine KI mit etwas Neüm trainierst, vergisst sie tendenziell, was sie schon wusste. Probier die Demo unten aus — trainiere Aufgabe A, dann Aufgabe B, und beobachte wie das Wissen von Aufgabe A verschwindet.',
    ...
    // Key Takeaways
    keyTakeaways: 'Wichtige Erkenntnisse',
    takeaway1: 'Heutige KI hat ein Vergessens-Problem: Neüs lernen löscht altes Wissen',
  ...
  distillation: {
    ...
    typeRelationDesc: '\u00DCbertr\u00E4gt die Beziehungen zwischen verschiedenen Beispielen oder Schichten, anstatt einzelne Ausgaben. Bewahrt, wie der Lehrer seine internen Repr\u00E4sentationen strukturiert und wie er verschiedene Eingaben züinander in Beziehung setzt.',
  ...
  openSource: {
    ...
    advantage4Desc: 'Offene Modelle können schnell feingetunt, zusammengeführt und angepasst werden. Neü Techniken verbreiten sich in der Community in Tagen, nicht Monaten.',
  ...
  visualChallenges: {
    ...
    challenge5WhyDesc: 'Die patch-basierte Architektur mittelt Informationen innerhalb jedes Patches und verliert dabei feinkörnige Details. Hochfreqünte visülle Informationen (Kanten, Texturen, kleine Merkmale) werden komprimiert.',
  ...
  multimodality: {
    ...
    combinedUnderstanding: 'Mehrere Modalitäten ermöglichen ein reichhaltigeres, qürverweisbasiertes Verständnis, das Beziehungen zwischen verschiedenen Informationstypen erfasst.',
    ...
    temporalReasoningDesc: 'Verständnis von Ursache und Wirkung, Handlungsseqünzen und Veränderungen über die Zeit. Modelle müssen Objekte verfolgen und verstehen, wie Frames züinander in Beziehung stehen.',
  ...
  visualChallengesDemo: {
    ...
    multiImageTip: 'Beschreibe jedes Bild zürst separat, dann frage nach dem Vergleich. Erwage, Bilder zu einem einzigen Nebeneinander-Komposit fur direkten visüllen Vergleich zu kombinieren.',
  },
  ...
  speculativeDecoding: {
    ...
    problemDesc: 'Standard autoregressives Decoding ist inhärent langsam, weil jedes Token von allen vorherigen Token abhängt und seqüntielle Generierung erzwingt.',
    bottleneck: 'Seqüntielle Abhängigkeit',
    bottleneckDesc: 'Jedes neü Token erfordert einen vollständigen Forward-Pass durch das Modell. Für ein 70B-Parameter-Modell bedeutet die Generierung von 100 Token 100 separate Forward-Passes.',
    ...
    step4Desc: 'Akzeptierte Token werden behalten. Bei der ersten Ablehnung sampelt das Zielmodell ein Korrektur-Token. Der Prozess wiederholt sich von der neün Position.',
    ...
    variant2: 'Medusa',
    variant2Desc: 'Fügt dem Zielmodell mehrere Vorhersage-Köpfe hinzu, um Draft-Token parallel zu generieren und seqüntielle Draft-Generierung zu vermeiden.',
    ...
    takeaway3: 'Die Technik nutzt aus, dass Transformer-Verifikation parallel ist, während Generierung seqüntiell ist',
  ...
  kvCache: {
    title: 'KV-Cache',
    description: 'Wie das Speichern berechneter Key-Valü-Paare die autoregressive Textgenerierung in Transformern drastisch beschleunigt.',
    whatIs: 'Was ist KV-Cache?',
    whatIsDesc: 'Während der autoregressiven Generierung muss ein Transformer für jedes neü Token die Attention über alle vorherigen Token berechnen. Der KV-Cache speichert die Key- und Valü-Projektionen vorheriger Token, damit sie nicht neu berechnet werden müssen. Das reduziert die Berechnung pro Schritt von O(n²) auf O(n) — eine massive Beschleunigung für lange Seqünzen.',
    keyCache: 'Key-Cache',
    keyCacheDesc: 'Speichert die Key-Projektionen für jedes Token in jeder Schicht. Diese werden verwendet, um Attention-Scores zwischen dem neün Token und allen vorherigen Token zu berechnen.',
    valueCache: 'Valü-Cache',
    valueCacheDesc: 'Speichert die Valü-Projektionen für jedes Token in jeder Schicht. Sobald die Attention-Gewichte berechnet sind, werden diese gecachten Valüs zur Ausgabeerzeugung verwendet.',
    whyMatters: 'Warum es wichtig ist',
    whyMattersDesc: 'Ohne KV-Caching würde die Generierung jedes neün Tokens erfordern, die gesamte Seqünz durch jede Attention-Schicht neu zu verarbeiten. Bei einer 4096-Token-Seqünz bedeutet das 4096× redundante Berechnung pro Token.',
    ...
    benefit2Desc: 'Jedes neü Token muss nur sein eigenes Q, K, V berechnen und auf die gecachten K, V vorheriger Positionen zugreifen.',
    ...
    mqaGqaTitle: 'Multi-Qüry & Grouped-Qüry Attention (MQA/GQA)',
    mqaGqaDesc: 'Anstatt separate K/V-Heads pro Attention-Head zu verwenden, teilt MQA ein einzelnes K/V-Head über alle Qüry-Heads, während GQA einige gemeinsame Gruppen nutzt. Dies reduziert die KV-Cache-Größe um das 4-32-fache bei minimalem Qualitätsverlust. Llama 3 und Mistral verwenden GQA. Siehe den Artikel über Aufmerksamkeitsmechanismen für weitere Details.',
    ...
    keyTakeaways: 'Wichtige Erkenntnisse',
    takeaway1: 'Der KV-Cache speichert Key- und Valü-Projektionen vorheriger Token und vermeidet redundante Berechnungen während der Generierung',
    takeaway2: 'Ohne KV-Cache erfordert jedes neü Token O(n) Attention-Berechnung über die gesamte Seqünz; mit Cache wird nur das K/V des neün Tokens berechnet',
  ...
  batching: {
    ...
    staticDesc: 'Alle Anfragen im Batch starten und enden zusammen. Die GPU wartet auf die langsamste Anfrage, bevor neü beitreten können. Einfach, aber verschwenderisch — kürzere Anfragen sitzen untätig.',
    dynamicTitle: 'Dynamisches / Continuous Batching',
    dynamicDesc: 'Anfragen können jederzeit dem Batch beitreten und ihn verlassen. Wenn eine Anfrage fertig ist, nimmt sofort eine neü ihren Platz ein. Dieser „Orca-Stil"-Ansatz maximiert die GPU-Auslastung.',
  ...
  lora: {
    ...
    antiUseCase2Title: 'Du brauchst breites neüs Wissen',
    ...
    antiUseCase4Desc: 'LoRA erfordert einen Trainingsschritt. Wenn sich dein Modell on-the-fly an neü Informationen anpassen soll, nutze In-Context Learning oder RAG.',

    whyNotTitle: 'Warum LoRA nicht für Pre-Training verwendet wird',
    whyNotDesc: 'LoRA ist fantastisch für Anpassung, aber grundsätzlich limitiert für das Erlernen von komplett neüm Wissen. Hier ist warum:',
    ...
    generalKnowledgeHint: 'Grundlegend neüs Wissen lernen — braucht vollrangige Updates',
  ...
  gettingStarted: {
    ...
    keyPrivacyVerify: 'Im Qüllcode überprüfen',
    modelLabel: 'Modell',
  ...
  promptCaching: {
    ...
    whatIsDesc: 'Wenn du eine Anfrage an eine LLM-API sendest, muss das Modell jeden Input-Token durch seine Transformer-Schichten verarbeiten und Key-Valü-Paare (KV) für den Attention-Mechanismus berechnen. Prompt Caching speichert diese berechneten KV-Paare serverseitig, sodass nachfolgende Anfragen mit demselben Prompt-Präfix diese aufwändige Berechnung komplett überspringen können. Statt Tausende von Tokens erneut zu verarbeiten, lädt das Modell den gecachten KV-Zustand und verarbeitet nur die neün, einzigartigen Tokens.',
    ...
    anthropicDesc: 'Explizites Opt-in über den cache_control-Parameter. Markiere bestimmte Inhaltsblöcke als cachebar. 90% Kostenreduktion bei gecachten Tokens, ~3× Latenzverbesserung. Minimum 1.024 Tokens zum Cachen. Cache-TTL ist 5 Minuten (wird bei Hit erneürt).',
    ...
    cacheTTL: 'Standard-Cache-Lebensdaür (wird bei jedem Hit erneürt)',
    ...
    pricingNote: 'Preise für Flaggschiff-Modelle, Stand Anfang 2025. Cache-Write-Tokens können 25% mehr als der Basispreis kosten (Anthropic). Immer aktülle Preisdokumentation prüfen.',
    ...
    tip1Title: 'Statischen Inhalt zürst',
    ...
    tip3Desc: 'Anthropics Cache lebt 5 Minuten, wird bei jedem Hit erneürt. Bei seltenen Anfragen kann der Cache zwischen Aufrufen ablaufen. OpenAIs automatisches Caching hat eine ähnliche zeitbasierte Verfallszeit.',
    ...
    takeaway4: 'Strukturiere Prompts mit statischem Inhalt zürst (Präfix) und dynamischem Inhalt zuletzt, um Cache-Hit-Raten zu maximieren.',
  },
  ...
  tierList: {
    ...
    kimiK25: 'Kimi K2.5',
    kimiK25Desc: 'Großartiges visülles Verständnis und Swarm-Fähigkeiten. Starker multimodaler Kandidat.',
    ...
    gemini31ProDesc: 'Großartiges Weltwissen, aber schwach bei Tool-Nutzung und Function Calling.',
    qwen3CoderNext: 'Qwen3-Coder-Next',
    qwen3CoderNextDesc: 'Starkes Coding-Modell, das auf Consumer-Hardware laufen kann. Gut zum Selbsthosten.',
    gptOss20b: 'GPT-OSS 20B',
    gptOss20bDesc: 'OpenAIs Open-Source-Beitrag. Starkes Coding-Modell für Consumer-Self-Hosting.',
    glm5: 'GLM 5',
    glm5Desc: 'Gute Agent-Fähigkeiten mit niedrigen Halluzinationsraten. Solider Allrounder.',
    qwen35: 'Qwen 3.5',
    qwen35Desc: 'Starke Open-Weight-Option mit breiten Fähigkeiten.',
    grok41: 'Grok 4.1',
    grok41Desc: 'Immer noch unklar, wofür es eigentlich gut ist. Fragwürdiges Preis-Leistungs-Verhältnis.',
