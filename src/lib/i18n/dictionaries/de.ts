...
export const de: Dictionary = {
  ...
  tierList: {
    ...
    gpt56SolDesc: 'Fast so intelligent wie Claude Fable 5, aber für einen Bruchteil des Preises. Herausragendes Reasoning, Coding und agentische Ausführung machen es zum praktischen S-Tier-Standard.',
    gpt55: 'GPT-5.5',
    gpt55Desc: 'Weiterhin ein exzellentes Operator-Modell mit sauberer Tool-Nutzung und starkem Gespür für OpenClaw-artige Coding- und Infrastrukturarbeit.',
    claudeFable5: 'Claude Fable 5',
    claudeFable5Desc: '95% SWE-bench Verified. 1M Kontext, 128K Output. Das fähigste Modell, das je veröffentlicht wurde — Mythos-Klasse mit Guardrails. Absurd teuer bei $10/$50 pro MTok und aktuell offline wegen US-Exportkontrolle.',
    claudeOpus48: 'Claude Opus 4.8',
    claudeOpus48Desc: 'Immer noch der König für tiefe Arbeit. Der sichere Fallback, wenn Fable 5 blockt. Teuer, aber wert für hartes Reasoning und emotionale Interpretation.',
    gpt54: 'GPT-5.4',
    gpt54Desc: 'Weiterhin exzellent: 1M Kontext, 33% weniger Halluzinationen als 5.2, Tool Search System. Jetzt A-Tier, nachdem GPT-5.5 den Spitzenplatz übernommen hat.',
    ...
    claudeOpus47Desc: 'Wenn du das Geld hast, bleibt das hier der König für tiefe Arbeit. Teuer, sorgfältig und absurd stark bei hartem Reasoning.',
    gemini3Flash: 'Gemini 3.5 Flash',
    gemini3FlashDesc: 'Sehr leistungsfähig und unglaublich schnell. Der starke Preissprung gegenüber dem früheren Flash-Modell macht es aber deutlich teurer, sodass GPT-5.5 es in vielen Workflows aussticht.',
    deepseekV4: 'DeepSeek 4',
    deepseekV4Desc: 'Neue A-Tier-DeepSeek-Wahl: starkes Reasoning und gutes Preis-Leistungs-Verhältnis, ersetzt den alten 3.2-Slot.',
    minimax27: 'MiniMax M2.7',
    minimax27Desc: 'Self-evolving Architektur. SWE-Pro 56%, herausragendes Preis-Leistungs-Verhältnis via OpenRouter. S-Tier Coding & Reasoning — überragend in allen Disziplinen.',
    kimiK26: 'Kimi 2.6',
    kimiK26Desc: 'Starker Agent, starkes visuelles Verständnis. Gerade eines der besten multimodalen Allround-Modelle.',
    qwen36_27bA3: 'Qwen 3.6 27B-A3',
    qwen36_27bA3Desc: 'Absurd gut für die Größe. Schnell, günstig zu betreiben und lokal stark genug für A-Tier.',
    glm47Flash: 'GLM 4.7 Flash',
    glm47FlashDesc: 'Kann auf Consumer-GPUs selbst gehostet werden. Beeindruckende Leistung für seine Größe.',
    gemini31Pro: 'Gemini 3.1 Pro',
    gemini31ProDesc: 'Benchmaxxed-Enttäuschung. Toppt Leaderboards, versagt aber in echten Agent-Workflows. Google, warum nur?',
    qwen3Next80b: 'Qwen3-Next 80B',
    qwen3Next80bDesc: 'Hybrid-Attention MoE mit spekulativem Decoding. 80B gesamt, aber nur 3B aktiv — läuft auf Consumer-GPUs.',
    glm51: 'GLM 5.1',
    glm51Desc: 'Opus-Tier-Gefühl für etwa 10% des Preises. Top-Tier Reasoning und Agent-Fähigkeiten mit absurdem Preis-Leistungs-Verhältnis.',
    qwen35: 'Qwen 3.5',
    grok420: 'Grok 4.20',
    grok420Desc: 'Starkes suchgestütztes Modell. Am besten für Echtzeit-Webrecherche.',
