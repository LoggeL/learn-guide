...
export const de: Dictionary = {
  ...
  features: {
    ...
    buildIntuition: 'Intuition aufbaün',
  ...
  topicDescriptions: {
    ...
    'temperature': 'Zufälligkeit und Kreativität in LLM-Ausgaben steürn',
    ...
    'responsible-ai': 'KI-Systeme baün, die fair, transparent und sicher sind',
  ...
  temperature: {
    title: 'Temperatur',
    description: 'Verstehe, wie ein einzelner Parameter die Balance zwischen vorhersagbarer Logik und kreativer Zufälligkeit in KI-Ausgaben steürt.',
    whatIs: 'Was ist Temperatur?',
    whatIsDesc: 'In LLMs ist Temperatur ein Hyperparameter, der die "Logits" (Rohwerte) der nächsten Token-Vorhersagen skaliert, bevor sie in Wahrscheinlichkeiten umgewandelt werden. Er steürt im Wesentlichen, wie stark das Modell die wahrscheinlichsten Optionen gegenüber weniger wahrscheinlichen bevorzugt.',
    ...
    highTempDesc: 'Verteilt Wahrscheinlichkeit auf mehr Tokens. Vielfältig, kreativ und überraschend. Ideal für Geschichten, Brainstorming und Pösie.',
  ...
  agentSecurity: {
    ...
    vector1: 'HTTP-Anfragen — POST-Daten an angreifergesteürte Endpunkte',
  ...
  agenticPatterns: {
    ...
    pattern2Desc: 'Erstelle zürst einen übergeordneten Plan, dann führe die Schritte sequentiell aus.',
  ...
  interactive: {
    ...
    textDiffusionInsightPoint3: 'Die Aufdeckreihenfolge basiert auf Konfidenz, nicht auf Position — einfache Wörter wie "the" erscheinen zürst, während schwierigere Wörter wie "windowsill" mehr Schritte brauchen.',
  ...
  tokenization: {
    ...
    specialTokensDesc: 'Markierungen wie <|endoftext|> oder [CLS] zur Modellsteürung.',
    interactiveDemo: 'Interaktive Demo',
  ...
  diffusion: {
    ...
    imageTrackDesc: 'Arbeitet auf latenten Bildrepräsentationen und entrauscht sie zu konsistenten Bildern, gesteürt durch Textbedingungen.',
    roadmapTitle: 'Lernpfad',
    roadmapDesc: 'Folge dieser Reihenfolge, um Intuition von den Grundlagen bis zu modalitiespezifischen Systemen aufzubaün.',
  ...
  diffusionFundamentals: {
    ...
    takeaway3: 'Scheduler steürn, wo Modellkapazität über Zeitstufen investiert wird.',
  ...
  imageDiffusion: {
    ...
    takeaway3: 'Textkonditionierung und CFG steürn die Stärke der Promptausrichtung.',
  ...
  rag: {
    ...
    agenticRagDesc: 'Bei agentic RAG empfängt das LLM nicht nur abgerufene Dokumente—es steürt aktiv den Abrufprozess. Das Modell entscheidet, wann gesucht wird, wonach gesucht wird und welche Abrufwerkzeuge verwendet werden.',
    ...
    agenticTagline: 'LLM-gesteürt, iterativer Prozess',
    ...
    queryHydeDesc: 'Generiere zürst eine hypothetische Antwort, dann verwende die Einbettung dieser Antwort fur den Abruf. Dies überbrückt die Lücke zwischen Frage- und Dokument-Einbettungsraumen.',
  ...
  programmaticTools: {
    ...
    allowedCallersDesc: 'Bei der Tool-Definition gibst du an, welche Kontexte das Tool aufrufen können. So steürst du, ob ein Tool nur direkt vom Modell, nur aus der Code-Ausführung oder beides aufgerufen werden kann.',
    ...
    takeaway3: 'Mit allowed_callers steürst du, ob Tools direkt, aus Code oder beides aufgerufen werden.',
  ...
  memorySystems: {
    ...
    whatIsDesc: 'Speichersysteme ermöglichen es Agenten, Informationen über das unmittelbare Kontextfenster hinaus zu behalten und abzurufen. Sie ermöglichen Agenten, aus vergangenen Interaktionen zu lernen und kohärentes Langzeitverhalten aufrechtzürhalten.',
  ...
  evaluation: {
    ...
    interactiveApproach3Desc: 'Bewerte Kohärenz über lange Konversationen mit Kontextwechseln. Prüfe, ob der Agent genaün Zustand beibehält und Anweisungen über die Zeit befolgt.',
  ...
  worldModels: {
    ...
    latentDimInstruction: 'Ziehe die Regler, um zu sehen, wie jede latente Dimension ein komplexes visuelles Konzept unabhängig steürt.',
    latentZ1: 'Tageszeit',
    ...
    examplesIntro: 'Führende Forschungslabore und Unternehmen baün World Models für verschiedene Domänen. Klicke auf eine Karte für mehr Details.',
    ...
    uniSimDetail: 'UniSim lernt aus diversen Videodaten, um ein einheitliches Simulations-Framework aufzubaün, das domänenübergreifend funktioniert. Anders als spezialisierte Simulatoren kann es Küchen, Außenszenen, Fahrumgebungen und mehr modellieren — alles aus einem einzigen Modell, trainiert auf Internet-Videodaten.',
  ...
  trainingData: {
    ...
    syntheticWizardDesc: 'Nutzt "evolutionäres Instruktions-Tuning" — beginnend mit einfachen Prompts und iterativer Steigerung der Komplexität durch LLM-gesteürte Evolution. Dies erzeugt einen vielfältigen Satz zunehmend anspruchsvoller Anweisungen.',
  ...
  nestedLearning: {
    ...
    mattersDesc: 'Wenn das im großen Maßstab funktioniert, ändert es alles daran, wie wir KI baün:',
  ...
  distillation: {
    ...
    lossT: 'Temperatur: steürt, wie weich/glatt die Verteilungen sind. H\u00F6here T enth\u00FCllt mehr Beziehungen zwischen Klassen.',
    ...
    typeOnlineDesc: 'Lehrer und Sch\u00FCler trainieren gleichzeitig und lernen voneinander. Kein vortrainierter Lehrer erforderlich. N\u00FCtzlich, wenn man es sich nicht leisten kann, zürst ein massives Lehrer-Modell zu trainieren.',
  ...
  visualChallenges: {
    ...
    challenge1WhyDesc: 'Bildmodelle verarbeiten Bilder als Patches (typischerweise 14x14 oder 16x16 Pixel), nicht als diskrete Objekte. Ihnen fehlt das eingebaute Konzept der "Objektpermanenz" und sie haben Schwierigkeiten, genaü Zählungen über überlappende oder dichte Anordnungen aufrechtzürhalten.',
    ...
    challenge2WhyDesc: 'Positionsinformationen werden durch Patch-Positionseinbettungen kodiert, aber diese bieten keine Pixel-genaü Präzision. Das Modell lernt statistische Korrelationen zwischen Positionen statt explizites räumliches Denken.',
    ...
    challenge6MitigationDesc: 'Beschreibe jedes Bild zürst separat, dann frage nach dem Vergleich. Erwäge, Bilder zu einem einzigen Komposit für direkten Vergleich zu kombinieren.',
  ...
  agenticVision: {
    ...
    model3Desc: 'Kombiniert große Reasoning-Modelle mit verstärkungslernbasierter UI-Interaktion und ermöglicht pixelgenaüs Zeigen auf Objekte und UI-Elemente.',
    ...
    app1Desc: 'Automatisches Heranzoomen an Tabellen, Diagramme und Kleingedrucktes, um genaü Daten aus komplexen Dokumenten zu extrahieren.',
  ...
  multimodality: {
    ...
    // Kernerkenntnisse
    keyTakeaways: 'Kernerkenntnisse',
    takeaway1: 'Multimodale KI kombiniert Text, Bilder, Audio und Video, um ein reichhaltigeres Verständnis der Welt aufzubaün',
  ...
  visualChallengesDemo: {
    ...
    spatialScenario: 'Ein Foto, das eine rote Tasse auf der LINKEN Seite einer blaün Tasse zeigt, beide auf einem weissen Tisch.',
    spatialVlmResponse: '"Die rote Tasse befindet sich rechts von der blaün Tasse auf dem Tisch."',
    spatialActual: 'Die rote Tasse befindet sich auf der LINKEN Seite der blaün Tasse.',
    spatialWhy: 'Positionsinformationen werden durch Patch-Einbettungen ohne Pixel-genaü Prazision kodiert. Das Modell lernt statistische Korrelationen anstatt explizites raumliches Denken, was Links/Rechts-Verwechslungen haufig macht.',
    ...
    multiImageTip: 'Beschreibe jedes Bild zürst separat, dann frage nach dem Vergleich. Erwage, Bilder zu einem einzigen Nebeneinander-Komposit fur direkten visuellen Vergleich zu kombinieren.',
  },
  ...
  gettingStarted: {
    ...
    breakdownModelHint: 'Das genaü Modell, das deine Anfrage verarbeitet hat.',
    ...
    understandModel: 'Das genaü Modell, das deine Anfrage verarbeitet hat. Einige Anbieter können an verschiedene Versionen weiterleiten.',
    nextStepsTitle: 'Nächste Schritte',
    nextStepsDesc: 'Jetzt, wo du deinen ersten LLM-Aufruf gemacht hast, erkunde diese Themen:',
    nextTemperature: 'Lerne, wie Temperatur Kreativität vs. Vorhersagbarkeit steürt',
  ...
  learningPath: {
    ...
    lpTemperature: 'Verstehe, wie Zufälligkeit kreative vs. präzise Ausgaben steürt',
  ...
  tierList: {
    ...
    minimax27Desc: 'Self-evolving Architektur. SWE-Pro 56%, herausragendes Preis-Leistungs-Verhältnis via OpenRouter. A-Tier Coding & Reasoning.',
    kimiK25: 'Kimi K2.5',
