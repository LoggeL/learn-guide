...
export const de: Dictionary = {
  ...
  kvCache: {
    ...
    turboQuantTitle: 'TurboQuant, PolarQuant & QJL (Google Research)',
    turboQuantDesc: 'Googles neuere KV-Compression-Linie greift einen anderen Engpass an: nicht nur, wie viele KV-Vektoren gespeichert werden, sondern wie stark man jeden einzelnen Vektor komprimieren kann, ohne die Attention-Qualität zu ruinieren. TurboQuant kombiniert zwei Ideen: eine starke Quantisierung für das Hauptsignal und danach einen winzigen Korrekturschritt für den Restfehler.',
    polarQuantTitle: 'PolarQuant',
    polarQuantDesc: 'Rotiert Vektoren zufällig vor der Quantisierung, damit ihre Geometrie leichter hochwertig komprimiert werden kann. Hier landet der Großteil der verfügbaren Bits.',
    qjlTitle: 'QJL',
    qjlDesc: 'Quantized Johnson-Lindenstrauss fügt eine winzige Low-Bit-Korrektur für den verbleibenden Fehler hinzu und reduziert so Bias in den Attention-Scores.',
    whyNewTitle: 'Warum das spannend ist',
    whyNewDesc: 'Für KV-Cache-Kompression ist das relevant, weil der eigentliche Feind der Speicher-Overhead ist. TurboQuant verspricht extreme Kompression bei kaum oder keinem Qualitätsverlust — gerade für Long-Context-Inferenz potenziell sehr wichtig.',
    keyTakeaways: 'Wichtige Erkenntnisse',
