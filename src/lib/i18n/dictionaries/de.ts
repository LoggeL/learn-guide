...
export const de: Dictionary = {
  ...
  diffusion: {
    ...
    textTrackDesc: 'Arbeitet auf maskierten Token-Sequenzen und verfeinert Token-Schaetzungen iterativ mit denoising-aehnlichen Updates.',
    imageTrackTitle: 'Bild-Diffusion',
    imageTrackDesc: 'Arbeitet auf latenten Bildrepraesentationen und entrauscht sie zu konsistenten Bildern, gesteuert durch Textbedingungen.',
    ...
    roadmapFundamentalsDesc: 'Vorwaertsrauschen, Rueckwaerts-Entrauschen, Scheduler und Score-Matching-Intuition.',
    ...
    openTopic: 'Thema oeffnen',
  },

  // Diffusions-Grundlagen
  diffusionFundamentals: {
    title: 'Wie Diffusion funktioniert',
    description: 'Baue Intuition fuer Vorwaertskorruption, Rueckwaerts-Entrauschen, Scheduler und scorebasiertes Lernen auf.',
    forwardProcess: 'Vorwaertsprozess (Korruption)',
    forwardProcessDesc: 'Der Vorwaertsprozess injiziert schrittweise Rauschen in saubere Samples, bis die Struktur weitgehend zerstoert ist. So entstehen Trainingspaare, die zeigen, welches Rauschen pro Schritt hinzugefuegt wurde.',
    ...
    forwardStep2Desc: 'Jeder Zeitschritt fuegt kontrolliertes gaussches oder diskretes Rauschen hinzu.',
    forwardStep3Title: 'Nahezu zufaelligen Zustand erreichen',
    forwardStep3Desc: 'Nach vielen Schritten naehert sich xT einer einfachen Priorverteilung an.',
    reverseProcess: 'Rueckwaertsprozess (Generierung)',
    ...
    noisePredictionIntuitionDesc: 'Rauschen zu schaetzen ist oft leichter, als direkt das saubere Sample zu prognostizieren. Sobald das Rauschen geschaetzt ist, kann es subtrahiert und Struktur progressiv wiederhergestellt werden.',
    schedulers: 'Scheduler: Linear vs Cosine',
    schedulersDesc: 'Scheduler legen fest, wie viel Rauschen pro Schritt hinzugefuegt oder entfernt wird. Sie beeinflussen Stabilitaet, Qualitaet und Geschwindigkeit stark.',
    schedulerLinearTitle: 'Linearer Scheduler',
    schedulerLinearDesc: 'Rauschen aendert sich pro Schritt mit konstanter Rate. Einfach, vorhersehbar und leicht zu implementieren.',
    schedulerCosineTitle: 'Cosine-Scheduler',
    schedulerCosineDesc: 'Verteilt den Entrauschungsaufwand nichtlinear, behaelt oft laenger nuetzliches Signal und verbessert die wahrgenommene Qualitaet.',
    scoreMatching: 'Score-Matching-Intuition',
    scoreMatchingDesc: 'Eine Score-Funktion schaetzt den Gradienten der Log-Dichte und zeigt in Richtung wahrscheinlicher Datenbereiche. Entrauschungsupdates folgen dieser Richtung und bewegen verrauschte Zustaende zurueck auf den Datenmanifold.',
    interactiveTitle: 'Rauschen-zu-Signal-Visualisierung',
    interactiveDesc: 'Passe Rauschen manuell an oder nutze Vorwaerts-/Rueckwaerts-Autoplay, um zu sehen, wie Struktur verschwindet und wieder erscheint.',
    keyTakeaways: 'Wichtige Erkenntnisse',
    takeaway1: 'Diffusionstraining lernt die Umkehrung eines bekannten Korruptionsprozesses.',
    takeaway2: 'Rueckwaertssampling ist iterative Verfeinerung, keine Ein-Schritt-Generierung.',
    takeaway3: 'Scheduler steuern, wo Modellkapazitaet ueber Zeitstufen investiert wird.',
    takeaway4: 'Score-Schaetzung liefert eine geometrische Sicht auf die Entrauschungsrichtung.',
  },
  ...
  textDiffusion: {
    ...
    discreteVsContinuousDesc: 'Sprache ist grundsaetzlich diskret, daher nutzen Text-Diffusionsmodelle oft Token-Maskierung und Ersetzung. Manche Ansaetze diffundieren in kontinuierlichen Embedding-Raeumen und projizieren danach zurueck.',
    maskPredict: 'Mask-and-Predict-Paradigma',
    maskPredictDesc: 'Text-Diffusion startet oft mit stark maskierten Sequenzen und sagt fehlende Tokens wiederholt voraus. Konfidenzbasiertes Remasking und Verfeinerung verbessern haeufig die Kohaerenz.',
    mdlmTitle: 'MDLM-aehnliche Modelle',
    mdlmDesc: 'Masked Diffusion Language Models entrauschen Token-Raster iterativ statt links-nach-rechts zu dekodieren.',
    seddTitle: 'SEDD-aehnliche Modelle',
    seddDesc: 'Score-Entropy-Varianten uebertragen scorebasierte Ideen auf diskrete Vokabulare mit probabilistisch fundierten Zielen.',
    paddingTokens: 'Padding-Tokens und feste Laenge',
    paddingTokensDesc: 'Gebatchte Diffusion verwendet oft feste Sequenzlaengen. [PAD]-Tokens fuellen ungenutzte Positionen, und Attention-Masks verhindern Einfluss auf Inhalts-Tokens.',
    vsAutoregressive: 'Unterschiede zu autoregressiven LMs',
    vsAutoregressiveDesc: 'Autoregressive Modelle sagen das naechste Token auf Basis vorheriger Tokens voraus. Diffusionsbasierte Textmodelle verfeinern viele Positionen parallel ueber mehrere Entrauschungsiterationen.',
    ...
    autoregressiveColumnDesc: 'Strikte Links-nach-rechts-Generierung mit kausaler Abhaengigkeit und finaler Token-Festlegung pro Schritt.',
    interactiveTitle: 'Maskenverfeinerungs-Demo',
    interactiveDesc: 'Beobachte, wie [MASK]-Positionen Token fuer Token aufgedeckt und verfeinert werden, waehrend [PAD]-Positionen per Maskierung ausgeschlossen bleiben.',
    keyTakeaways: 'Wichtige Erkenntnisse',
    takeaway1: 'Text-Diffusion passt Entrauschung an diskrete Tokenraeume an.',
    takeaway2: 'Mask-and-Predict ermoeglicht parallele Verfeinerung statt strikter Links-nach-rechts-Generierung.',
    takeaway3: '[PAD] plus Attention-Masking ist zentral fuer effizientes Batching fester Laenge.',
    takeaway4: 'Gegenueber autoregressiven LMs tauscht Text-Diffusion mehr Schritte gegen iterative Korrektur.',
  },
  ...
  imageDiffusion: {
    ...
    latentPipelineDesc: 'Moderne Systeme diffundieren meist im latenten Raum: Bildlatente mit einem VAE kodieren, diese Latente entrauschen und anschliessend zurueck in Pixel dekodieren.',
    pipelineEncodeTitle: 'VAE encode',
    pipelineEncodeDesc: 'Komprimiere hochaufgeloeste Pixel in ein niedriger-dimensionales latentes Tensorformat.',
    ...
    pipelineDecodeDesc: 'Projiziere finale Latente zurueck in den RGB-Bildraum.',
    unetVsDit: 'U-Net vs DiT Backbones',
    unetVsDitDesc: 'U-Nets praegten fruehe Diffusionsmodelle mit starken raeumlichen Induktionsbiases. DiTs ersetzen Faltungen durch Transformer-Bloecke und skalieren oft besser mit Daten und Rechenbudget.',
    unetTitle: 'U-Net',
    unetDesc: 'Konvolutionaler Encoder-Decoder mit Skip-Connections fuer mehrskalige raeumliche Rekonstruktion.',
    ditTitle: 'DiT (Diffusion Transformer)',
    ditDesc: 'Transformer-Backbone ueber patchifizierte Latente, oft stark bei grosser Skalierung und grossen Trainingsbudgets.',
    ...
    cfgDesc: 'CFG mischt konditionierte und unkonditionierte Vorhersagen. Hoehere Guidance staerkt Prompttreue, kann aber Vielfalt reduzieren und Artefakte verstaerken.',
    stepsTradeoff: 'Schritte vs Qualitaet Trade-off',
    stepsTradeoffDesc: 'Mehr Entrauschungsschritte verbessern haeufig die Qualitaet, erhoehen aber Latenz. In der Praxis werden Schrittzahl, Scheduler und Guidance auf Qualitaet pro Sekunde abgestimmt.',
    interactiveTitle: 'Interaktive Rausch- und Entrausch-Demo',
    interactiveDesc: 'Nutze den Visualizer, um Vorwaertsrauschen und Rueckwaerts-Entrauschen in einem diffusionsaehnlichen Prozess zu simulieren.',
    keyTakeaways: 'Wichtige Erkenntnisse',
    takeaway1: 'Latente Diffusion steigert Recheneffizienz bei hoher Bildqualitaet.',
    takeaway2: 'U-Net und DiT haben unterschiedliche Induktionsbias- und Skalierungs-Trade-offs.',
    takeaway3: 'Textkonditionierung und CFG steuern die Staerke der Promptausrichtung.',
    takeaway4: 'Bildqualitaet haengt von gemeinsamer Abstimmung aus Schritten, Scheduler und Guidance ab.',
  },
  ...
  programmaticTools: {
    ...
    useCase2Desc: 'Zuerst die Dateigröße prüfen, dann entscheiden, ob die ganze Datei oder nur eine Zusammenfassung gelesen wird. Keine verschwendeten Roundtrips.',
