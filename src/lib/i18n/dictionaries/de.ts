...
export const de: Dictionary = {
  ...
  worldModels: {
    ...
    keyInsightQuote: 'Die nächste Grenze der KI ist nicht nur Sprache zu verstehen — sondern die physische Welt zu verstehen.',
    keyInsightAttribution: '— Yann LeCun, Meta AI Chief Scientist, über die Bedeutung von World Models für AGI',
    ...
    comparisonTitle: 'Training-Vergleich',
    comparisonSubtitle: 'Wechsle zwischen Real-World und World-Model Training um die Unterschiede zu sehen',
    realWorldTraining: 'Real World Training',
    worldModelTraining: 'World Model Training',
    compSpeed: 'Geschwindigkeit',
    compSpeedReal: '1x Echtzeit',
    compSpeedWorld: '1.000x–430.000x Echtzeit',
    compCost: 'Kosten',
    compCostReal: '100.000€+ pro Roboter',
    compCostWorld: 'Nur GPU-Rechenzeit',
    compParallel: 'Parallelisierung',
    compParallelReal: '1 Roboter = 1 Instanz',
    compParallelWorld: '1000e parallele Instanzen',
    compSafety: 'Sicherheit',
    compSafetyReal: 'Schäden & Verletzungsrisiko',
    compSafetyWorld: 'Null physisches Risiko',
    compDiversity: 'Szenario-Vielfalt',
    compDiversityReal: 'Begrenzt durch physischen Aufbau',
    compDiversityWorld: 'Unbegrenzte prozedurale Generierung',
    trainingLoopTitle: 'Der Robotik-Trainingskreislauf',
    trainingLoopDesc: 'World Models ermöglichen einen kontinuierlichen Verbesserungszyklus: Szenarien simulieren, Policies trainieren, in der realen Welt evaluieren, Daten sammeln um das Modell zu verfeinern — und wiederholen. Jede Iteration verbessert sowohl das World Model als auch die Roboter-Policy.',
    simToRealTitle: 'Der Sim-to-Real Gap',
    simToRealIntro: 'Die größte Herausforderung beim simulationsbasierten Training: Was in einer simulierten Welt perfekt funktioniert, kann in der Realität versagen. Unterschiede in Physik-Genauigkeit, Sensor-Rauschen, Beleuchtung und Materialeigenschaften erzeugen eine „Lücke", die Forscher intensiv zu schließen versuchen.',
    examples: 'Bekannte World Models',
    nvidiaCosmos: 'NVIDIA Cosmos',
    nvidiaCosmosDesc: 'Open-Source Physical-AI-Plattform zur Generierung synthetischer Trainingsdaten für Robotik und autonomes Fahren. Nutzt Video-Foundation-Modelle zur Simulation komplexer Fahrszenarien mit realistischer Physik.',
    googleGenie: 'Google Genie 2',
    googleGenieDesc: 'Generiert interaktive, spielbare 3D-Welten aus Textbeschreibungen oder Bildern. Erzeugt konsistente Umgebungen mit realistischer Physik und unterstützt Agenten-Interaktion.',
    uniSim: 'UniSim',
    uniSimDesc: 'Google Researchs universeller Weltsimulator. Lernt aus diversen Datenquellen, um jede Umgebung zu simulieren — von Küchen bis Autobahnen — in einem einheitlichen Framework.',
    gaia1: 'GAIA-1',
    gaia1Desc: 'Wayves generatives World Model für autonomes Fahren, trainiert auf Londoner Straßendaten. Sagt realistische Fahrszenarien vorher und generiert neuartige Verkehrssituationen.',
    genesis: 'Genesis',
    genesisDesc: 'Physik-Engine kombiniert mit generativer KI. Simulationen bis zu 430.000x schneller als Echtzeit mit physikalisch akkurater Dynamik für Robotik-Training.',
    dreamerV3: 'DreamerV3',
    dreamerV3Desc: 'Ein universelles World Model, das durch „Träumen" lernt — es stellt sich Zukunftsszenarien im latenten Raum vor und trainiert Policies auf diesen imaginierten Erfahrungen.',
    ...
    industrialSim: 'Industrielle Simulation',
    industrialSimDesc: 'Fertigungsprozesse, Lagerlogistik und Lieferketten in Digital-Twin-Umgebungen optimieren.',
    gameWorlds: 'Spielwelt-Generierung',
    gameWorldsDesc: 'Prozedurale Erstellung interaktiver Spielumgebungen mit realistischer Physik und konsistentem Objektverhalten.',
    ...
    dataHunger: 'Datenanforderungen',
    dataHungerDesc: 'Hochwertige Videodaten mit diversen Szenarien, Kamerawinkeln und physikalischen Interaktionen sind knapp und teuer in großem Maßstab zu sammeln.',
    evaluation: 'Evaluationsmetriken',
    evaluationDesc: 'Wie misst man, ob ein World Model Physik „versteht"? Standard-Metriken wie FID erfassen physikalische Plausibilität nur unzureichend.',
    futureTitle: 'Die Zukunft von World Models',
    futureDesc: 'World Models entwickeln sich rasant weiter. Hier sind die wichtigsten Trends für die nächste Generation:',
    futureMultimodal: 'Multimodale World Models',
    futureMultimodalDesc: 'Kombination von Vision, Sprache, Audio und taktiler Wahrnehmung in einheitlichen Weltrepräsentationen.',
    futureComposable: 'Komponierbare World Models',
    futureComposableDesc: 'Komplexe Umgebungen durch Kombination kleinerer, spezialisierter Modelle aufbauen — wie LEGO-Bausteine für Weltsimulation.',
    futureFoundation: 'Foundation World Models',
    futureFoundationDesc: 'Vortrainiert auf massiven Videodaten, dann für spezifische Domänen feingetunt — wie GPT, aber für physikalisches Verständnis.',
    futureLLMIntegration: 'LLM + World Model Fusion',
    futureLLMIntegrationDesc: 'Kombination von Sprachverständnis mit physikalischem Schlussfolgern — für KI, die in der realen Welt sowohl denken als auch handeln kann.',
    keyTakeaways: 'Wichtige Erkenntnisse',
    ...
    takeaway3: 'Die Architektur folgt einer Pipeline: Sensor-Input → Encoder → Latente Welt → Decoder → Vorhersage',
    ...
    takeaway6: 'Die Zukunft liegt in Foundation World Models, die physikalisches Verständnis mit sprachlichem Schlussfolgern verbinden',
  },
