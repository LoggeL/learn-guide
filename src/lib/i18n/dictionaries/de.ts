...
export const de: Dictionary = {
  ...
  batching: {
    ...
    staticDesc: 'Alle Anfragen im Batch starten und enden zusammen. Die GPU wartet auf die langsamste Anfrage, bevor neue Anfragen beitreten können. Einfach, aber verschwenderisch — kürzere Anfragen sitzen untätig.',
    ...
    throughputExplain: 'Mit steigender Batch-Größe steigt der Gesamtdurchsatz zunächst steil an — und flacht dann ab. Das passiert, weil LLM-Inferenz speicherbandbreitenbegrenzt ist: Die GPU muss die gesamten Modellgewichte für jeden Forward-Pass aus dem DRAM laden. Mehr Batches teilen diese festen Kosten, aber irgendwann ist die DRAM-Bandbreite gesättigt und mehr Anfragen helfen kaum.',
    throughputLabel: 'Gesamtdurchsatz',
    latencyLabel: 'Latenz pro Anfrage',
    batchSizeLabel: 'Batch-Größe',
    tokPerSec: 'Tok/s',
    msPerTok: 'ms/Tok',
    plateauExplain: 'Das Plateau entsteht durch DRAM-Bandbreitensättigung — nicht Rechensättigung. Selbst bei Batch-Größe 256 sind die GPU-Recheneinheiten noch unterausgelastet. Der Engpass ist, wie schnell Gewichte aus dem Speicher geladen werden können.',
    improvementNote: '256× mehr Anfragen, aber nur ~33× mehr Durchsatz',
    ...
    prefillDesc: 'Alle Input-Token werden parallel in einem Forward-Pass verarbeitet. Diese Phase ist rechengebunden — die Tensor-Cores der GPU sind voll ausgelastet. Hier entsteht die Time to First Token (TTFT).',
    prefillAnalogy: 'Wie ein Fließband, das alle Teile auf einmal verarbeitet',
    decodeTitle: 'Decode-Phase',
    decodeDesc: 'Token werden einzeln generiert, jedes abhängig vom vorherigen. Diese Phase ist speichergebunden — weniger als 20% der GPU-Rechenleistung wird genutzt. Hier entsteht die Time Between Output Tokens (TBOT).',
    decodeAnalogy: 'Wie ein einzelner Handwerker, der Stück für Stück fertigt',
    prefillLabel: 'Prefill',
    decodeLabel: 'Decode',
    computeBound: 'Rechengebunden',
    memoryBound: 'Speichergebunden',
    highUtil: 'Hohe GPU-Auslastung',
    lowUtil: 'Niedrige GPU-Auslastung',
    parallelProcess: 'Alle Token parallel',
    sequentialProcess: 'Ein Token nach dem anderen',
    ttft: 'TTFT (Time to First Token)',
    tbot: 'TBOT (Time Between Output Tokens)',
    keyInsight: 'Beim Prefill ist fast die gesamte Latenz durch Berechnung bedingt. Beim Decode sind weniger als 20% Berechnung — der Rest ist Warten auf Speicher. Batching hilft am meisten beim Decode, weil einzelnes Decode die GPU kaum nutzt.',
    phaseAnimTitle: 'Beobachte die Phasen',
    phaseAnimSubtitle: 'Sieh, wie eine Anfrage durch Prefill und Decode fließt',
    ...
    lowBatchDesc: 'Niedriger Durchsatz, aber jeder Nutzer bekommt schnelle Antworten',
    highBatch: 'Große Batch-Größe',
    highBatchDesc: 'Hoher Durchsatz, aber jeder Nutzer wartet länger',
    tradeoffInsight: 'Der Sweet Spot hängt vom Anwendungsfall ab: Echtzeit-Chat braucht niedrige Latenz, während Batch-Verarbeitungsjobs den Durchsatz maximieren können.',
    continuousTitle: 'Continuous Batching',
    continuousSubtitle: 'Wie moderne Serving-Engines GPU-Leerlauf eliminieren',
    staticBatchTitle: 'Statisches Batching (Traditionell)',
    staticBatchDesc: 'Alle Anfragen müssen zusammen starten und der Batch wartet auf die längste Anfrage. Kürzere Anfragen verschwenden GPU-Zeit im Leerlauf.',
    continuousBatchTitle: 'Continuous Batching (Orca)',
    continuousBatchDesc: 'Fertige Anfragen verlassen sofort den Batch und neue treten spontan bei. Die GPU ist nie im Leerlauf, solange es Arbeit gibt.',
    slotLabel: 'Slot',
    activeLabel: 'Aktiv',
    idleLabel: 'Leerlauf',
    newReqLabel: 'Neue Anfrage tritt bei',
    finishedLabel: 'Fertig',
    keyTakeaways: 'Wichtige Erkenntnisse',
    takeaway1: 'Batching amortisiert die Kosten des Ladens von Modellgewichten über mehrere Anfragen und erhöht den Durchsatz dramatisch',
    takeaway2: 'LLM-Decode ist speicherbandbreitenbegrenzt — selbst große Batch-Größen nutzen die GPU-Rechenleistung nicht voll aus',
    takeaway3: 'Prefill ist rechengebunden (schnell, parallel), während Decode speichergebunden ist (langsam, sequentiell) — Batching hilft am meisten beim Decode',
    takeaway4: 'Continuous Batching eliminiert GPU-Leerlauf, indem Anfragen dynamisch dem Batch beitreten und ihn verlassen können',
  },
}
