...
export const de: Dictionary = {
  ...
  mcp: {
    ...
    serverGithub: 'GitHub',
    serverGithubDesc: 'Repository-Verwaltung, Issüs, Pull Requests und Code-Suche. Erfordert einen persönlichen Zugriffstoken.',
    serverSlack: 'Slack',
  ...
  promptCaching: {
    ...
    cacheTTL: 'Standard-Cache-Lebensdaür (wird bei jedem Hit erneuert)',
