...
export const de: Dictionary = {
  ...
  worldModels: {
    title: 'World Models',
    description: 'KI-Systeme, die eine interne Repräsentation der physischen Welt lernen.',
    whatIs: 'Was sind World Models?',
    whatIsDesc: 'World Models sind KI-Systeme, die eine interne Repräsentation der physischen Welt lernen, um die Zukunft vorherzusagen und zu simulieren. Sie verstehen Physik, Objektbewegungen und kausale Zusammenhänge.',
    whatIsDesc2: 'Anstatt nur Pixel-Muster zu lernen, entwickeln World Models ein tieferes Verständnis davon, wie die Welt funktioniert – ähnlich wie Menschen mentale Modelle der Realität aufbauen.',
    howTheyWork: 'Wie funktionieren sie?',
    howTheyWorkDesc: 'World Models kombinieren verschiedene Techniken, um physikalische Realität zu modellieren:',
    latentSpace: 'Latent Space Representation',
    latentSpaceDesc: 'Komprimierung hochdimensionaler Sensordaten (z.B. Video) in einen kompakten latenten Raum, der die Essenz der Szene erfasst.',
    videoPrediction: 'Video Prediction',
    videoPredictionDesc: 'Vorhersage zukünftiger Frames basierend auf vergangenen Beobachtungen und geplanten Aktionen.',
    physicsAware: 'Physics-Aware Training',
    physicsAwareDesc: 'Training mit physikalischen Constraints oder Simulatoren, damit das Modell realistische Bewegungen und Interaktionen lernt.',
    diffusion: 'Diffusion-basierte Ansätze',
    diffusionDesc: 'Nutzung von Diffusionsmodellen zur Generierung konsistenter, physikalisch plausibler Zukunftsvorhersagen.',
    whyNeeded: 'Warum braucht man sie?',
    slowExpensive: 'Realität ist langsam und teuer',
    slowExpensiveDesc: 'Roboter in der realen Welt zu trainieren ist zeitaufwändig, kostspielig und potenziell gefährlich. Ein Fehler kann Hardware zerstören oder Menschen gefährden.',
    parallelTraining: 'Parallelisiertes Training in Simulation',
    parallelTrainingDesc: 'World Models ermöglichen das Training tausender virtueller Agenten gleichzeitig, die Millionen von Stunden Erfahrung in Stunden sammeln können.',
    physicsUnderstanding: 'Textbasierte LLMs verstehen Physik nicht wirklich',
    physicsUnderstandingDesc: 'Sprachmodelle können über Physik sprechen, aber nicht wirklich räumliche Beziehungen, Momentum oder Schwerkraft verstehen. World Models lernen diese Konzepte durch Erfahrung.',
    examples: 'Beispiele',
    nvidiaCosmos: 'NVIDIA Cosmos',
    nvidiaCosmosDesc: 'Physikalische KI-Plattform für Robotik und autonomes Fahren. Generiert synthetische Trainingsdaten und simuliert komplexe Fahrszenarien.',
    googleGenie: 'Google Genie 2',
    googleGenieDesc: 'Generiert interaktive, spielbare 3D-Welten aus Textbeschreibungen oder Bildern. Kann konsistente Umgebungen mit realistischer Physik erzeugen.',
    genesis: 'Genesis',
    genesisDesc: 'Physik-Engine kombiniert mit generativer KI. Ermöglicht ultraschnelle, physikalisch akkurate Simulationen für Robotik-Training.',
    others: 'Weitere Modelle',
    othersDesc: 'UniSim (universelle Weltsimulation), GAIA-1 von Wayve (autonomes Fahren), und viele Forschungsprojekte im Bereich embodied AI.',
    useCases: 'Use Cases',
    autonomousDriving: 'Autonomes Fahren',
    autonomousDrivingDesc: 'Der größte aktuelle Einsatzbereich. World Models simulieren Verkehrsszenarien, testen Edge Cases und trainieren Fahrzeugpolitiken ohne reale Straßentests.',
    robotics: 'Robotik-Training',
    roboticsDesc: 'Training von Manipulations- und Navigationsfähigkeiten in Simulation, bevor Policies auf echte Roboter übertragen werden.',
    videoGeneration: 'Videogenerierung',
    videoGenerationDesc: 'Als "Nebenprodukt" können World Models auch zur Generierung realistischer Videos verwendet werden – obwohl das nicht ihr Hauptzweck ist.',
    challenges: 'Herausforderungen',
    challengesDesc: 'Trotz des Potenzials gibt es erhebliche Hürden:',
    computeIntensive: 'Extrem ressourcenhungrig',
    computeIntensiveDesc: 'Training erfordert enorme Rechenleistung und riesige Datensätze. Nur wenige Unternehmen können sich diese Modelle leisten.',
    simToReal: 'Sim-to-Real Gap',
    simToRealDesc: 'Was in der Simulation funktioniert, versagt manchmal in der Realität. Die Übertragung bleibt eine Herausforderung.',
    generalization: 'Generalisierung',
    generalizationDesc: 'World Models können auf ungesehene Szenarien überanpassen. Robuste Generalisierung ist noch ein offenes Problem.',
    keyTakeaways: 'Wichtige Erkenntnisse',
    takeaway1: 'World Models lernen interne Repräsentationen der physischen Welt für Vorhersage und Simulation',
    takeaway2: 'Sie ermöglichen massiv parallelisiertes Training in virtuellen Umgebungen statt langsamer Realzeit-Interaktion',
    takeaway3: 'Autonomes Fahren ist derzeit der größte Anwendungsbereich, aber Robotik holt auf',
    takeaway4: 'Training ist extrem rechenintensiv – nur wenige Player können sich hochwertige World Models leisten',
    takeaway5: 'Sim-to-Real Transfer und Generalisierung bleiben zentrale Forschungsherausforderungen',
  },
