...
export const de: Dictionary = {
  ...
  topicNames: {
    ...
    'feed-forward-networks-moe': 'Feed-Forward Networks & MoE',
  ...
  topicDescriptions: {
    ...
    'feed-forward-networks-moe': 'Wie Transformer-MLP-Blöcke Tokens verarbeiten und wie MoE Tokens durch Experts routet.',
  ...
  contextRot: {
    ...
    mitigation1Title: 'Kontext-Engineering',
    mitigation1: 'Kontext als begrenzte Ressource mit abnehmendem Ertrag behandeln. Anthropics empfohlener Ansatz: bewusst entscheiden, was wann eingeschlossen wird.',
    mitigation2Title: 'Positionsbewusstes Prompting',
    mitigation2: 'Kritische Anweisungen voranstellen und am Ende spiegeln. Die Sandwich-Technik stellt sicher, dass mindestens eine Kopie in einer Zone hoher Aufmerksamkeit landet.',
    mitigation3Title: 'Rekursives Chunking',
    mitigation3: 'Lange Dokumente in 400–512-Token-Chunks mit 10–20% Überlappung aufteilen. Dies ist der beste Standard für abrufbasierte Aufgaben.',
    mitigation4Title: 'Multi-Agenten-Architektur',
    mitigation4: 'Kontext auf spezialisierte Agenten aufteilen. Chroma 2025 fand eine 90,2%ige Verbesserung gegenüber Einzelagenten — jeder Agent erhält einen frischen, fokussierten Kontext.',
    mitigation5Title: 'Hierarchische Zusammenfassung',
    mitigation5: 'Mittleren Inhalt zusammenfassen und Zusammenfassungen an den Anfang stellen. Die mittleren Abschnitte bleiben als Referenz, aber Kernpunkte werden in Zonen hoher Aufmerksamkeit verschoben.',
    interactiveDemo: 'Interaktive Demo',
    demoDesc: 'Sieh, wie das Gedächtnis mit zunehmender Kontextlänge verblasst',
    keyTakeaways: 'Wichtige Erkenntnisse',
    takeaway1: 'Alle 18 getesteten Frontier-Modelle (GPT-4.1, Claude Opus 4, Gemini 2.5+) degradieren — das ist architektonisch, kein Bug',
    takeaway2: 'Stanfords "Lost in the Middle": 30%+ Genauigkeitsverlust, wenn Informationen in der Mitte statt am Anfang/Ende stehen',
    takeaway3: '100K Tokens = 10 Milliarden paarweise Aufmerksamkeitsbeziehungen — Softmax-Normalisierung verwässert jedes Token-Signal',
    takeaway4: 'Kohärente, strukturierte Dokumente verschlechtern die Leistung mehr als gemischte (Chroma-2025-Paradox)',
    takeaway5: 'Multi-Agenten-Architekturen erzielen 90,2% Verbesserung, indem jeder Agent einen fokussierten, frischen Kontext erhält',
    takeaway6: 'Kritische Infos voranstellen und spiegeln ist die effektivste Maßnahme mit 10–20% wiederherstellbarer Genauigkeit',
    ...
    // Hero stats
    heroIntro: 'Eine fundamentale Einschränkung aller frontier KI-Modelle — kein Bug, sondern eine architektonische Realität.',
    heroStat1Value: '18',
    heroStat1Label: 'Frontier-Modelle degradieren alle',
    heroStat2Value: '30%+',
    heroStat2Label: 'Genauigkeitsverlust in der Mitte',
    heroStat3Value: '2,55%',
    heroStat3Label: 'GPT-Halluzinationsrate (langer Kontext)',
    heroStat4Value: '90,2%',
    heroStat4Label: 'Verbesserung durch Multi-Agenten',
    // Science section
    scienceTitle: 'Die Wissenschaft: Lost in the Middle',
    scienceDesc: 'Liu et al. (Stanford) belegten ein U-förmiges Aufmerksamkeitsmuster bei allen getesteten Architekturen. Modelle verarbeiten Anfang und Ende gut, während mittlere Inhalte deutlich weniger Beachtung erhalten — was zu einem Genauigkeitsverlust von über 30% führt, wenn kritische Informationen in der Mitte vergraben sind.',
    attentionHeatmapTitle: 'U-förmige Aufmerksamkeitskurve',
    attentionHeatmapDesc: 'Klicke auf eine Position im Kontextfenster, um die Nadel zu platzieren. Die Genauigkeit basiert auf Liu et al. — Position ist entscheidend.',
    attentionClickHint: 'Klicke, um die Nadel zu platzieren',
    attentionAccuracyLabel: 'Abrufgenauigkeit',
    attentionStartLabel: 'Anfang',
    attentionMiddleLabel: 'Mitte',
    attentionEndLabel: 'Ende',
    attentionPositionLabel: 'Position',
    // Chroma 2025 section
    chromaTitle: 'Chroma 2025: 18 Modelle, gleiches Ergebnis',
    chromaDesc: 'Der Chroma-Benchmark testete GPT-4.1, Claude Opus 4, Gemini 2.5 Pro und 15 weitere Frontier-Modelle systematisch. Das Urteil war eindeutig: Jedes einzelne Modell degradiert mit wachsendem Kontext.',
    chromaFinding1Title: 'Universelle Degradierung',
    chromaFinding1Desc: 'Alle 18 getesteten Modelle degradieren — keine Ausnahmen. LongMemEval zeigte eine massive Lücke zwischen 300 Token und 113K Token für dieselbe Information.',
    chromaFinding2Title: 'Ähnlichkeitseffekt',
    chromaFinding2Desc: 'Geringe semantische Ähnlichkeit zwischen Nadel und Frage beschleunigt den Verfall. Wenn das Nadelthema nichts mit dem umgebenden Text zu tun hat, bricht der Abruf schneller ein.',
    chromaFinding3Title: 'Das Kohärenz-Paradox',
    chromaFinding3Desc: 'Überraschenderweise schaden kohärente, strukturierte Dokumente der Leistung mehr als gemischte. Kohärenter Text erzeugt stärkere semantische Interferenz im Aufmerksamkeitsmechanismus.',
    chromaFinding4Title: 'Modellunterschiede',
    chromaFinding4Desc: 'GPT-Modelle zeigen ~2,55% Halluzinationsrate bei langen Kontexten. Claude hat die niedrigste Rate — das Modell enthält sich eher als zu halluzinieren.',
    // Distractor demo
    distractorTitle: 'Ablenkungseffekt-Demo',
    distractorDesc: 'Passe die Ablenkungen an, um den Genauigkeitsabfall zu sehen — und wechsle den Modus, um das Kohärenz-Paradox in Aktion zu erleben.',
    distractorSliderLabel: 'Anzahl der Ablenkungen',
    distractorShuffledLabel: 'Gemischt',
    distractorCoherentLabel: 'Kohärent',
    distractorModeLabel: 'Heuhaufen-Modus',
    distractorAccuracyLabel: 'Genauigkeit',
    distractorParadoxNote: 'Kohärenter Kontext schadet der Leistung stärker — strukturierter Text erzeugt stärkere Interferenzmuster in der Aufmerksamkeit. Das ist das Chroma-2025-Paradox.',
    // Scale section
    scaleTitle: 'Das quadratische Skalierungsproblem',
    scaleDesc: 'Transformer-Aufmerksamkeit ist O(n²) — die Anzahl der Tokenpaarbeziehungen wächst quadratisch mit der Kontextlänge. Softmax normalisiert die Aufmerksamkeit über alle Tokens, sodass jedes Token bei wachsendem Kontext weniger Aufmerksamkeit erhält. Das ist Physik, kein behebbarer Bug.',
    scaleCalculatorTitle: 'Aufmerksamkeits-Komplexitätskalkulator',
    scaleInputLabel: 'Kontextlänge (Tokens)',
    scalePairwiseLabel: 'Paarweise Beziehungen',
    scaleAttentionLabel: 'Aufmerksamkeit pro Token',
    scaleReferenceTitle: 'Referenzskala',
    // Checklist
    checklistTitle: 'Praktische Checkliste',
    checklist1: 'Kritische Anweisungen voranstellen — in den ersten 5% des Kontexts platzieren',
    checklist2: 'Wichtige Anforderungen am Ende langer Prompts spiegeln (Sandwich-Technik)',
    checklist3: 'Rekursives Chunking verwenden (400–512 Tokens, 10–20% Überlappung) für lange Dokumente',
    checklist4: 'Bei Aufgaben mit mehr als 5 Schritten eine Multi-Agenten-Architektur in Betracht ziehen',
    checklist5: 'Mittlere Abschnitte zusammenfassen und die Zusammenfassung an den Anfang stellen',
    checklist6: 'Prompts bei 2× und 5× der erwarteten Kontextlänge testen',
  },
  ...
  transformerArchitecture: {
    ...
    concept1Desc: 'Skip-Connections, die den Input jeder Teilschicht direkt zu deren Output addieren. Sie lösen das Vanishing-Gradient-Problem und ermöglichen das Training sehr tiefer Netzwerke.',
  ...
  vision: {
    ...
    tokenExample1: '1024×1024 Foto (Patch-basiert, GPT-5-mini)',
    tokenExample1Value: '~1.660 Tokens',
    tokenExample2: '2048×1024 Diagramm (Kachel-basiert, GPT-4o)',
    tokenExample2Value: '~1.105 Tokens',
    ...
    imgTokenTitle: 'Bild-Tokenisierung in der Praxis',
    imgTokenDesc: 'Das Verständnis, wie Anbieter Bilder in Tokens umwandeln, ist entscheidend für die Kostenschätzung und Leistungsoptimierung.',
    imgTokenDisclaimer: 'Verschiedene Anbieter (OpenAI, Anthropic, Google) handhaben Bild-Tokenisierung unterschiedlich. Die folgenden Details basieren auf OpenAIs dokumentiertem Ansatz, aber die allgemeinen Prinzipien gelten anbieterübergreifend.',
    imgTokenPatchTitle: 'Patch-basierte Tokenisierung',
    imgTokenPatchModels: 'Neuere Modelle: GPT-5 Serie, o4-mini',
    imgTokenPatchDesc: 'Bilder werden mit 32×32 Pixel-Patches abgedeckt. Jeder Patch wird zu Tokens. Modelle haben ein Patch-Budget (z.B. 1.536 oder 2.500 Patches max). Wenn das Bild das Budget überschreitet, wird es proportional verkleinert. Ein modellspezifischer Multiplikator wandelt Patches in abgerechnete Tokens um.',
    imgTokenPatchMultipliers: 'Beispiel-Multiplikatoren: gpt-5-mini → 1,62×, gpt-5-nano → 2,46×, o4-mini → 1,72×',
    imgTokenTileTitle: 'Kachel-basierte Tokenisierung',
    imgTokenTileModels: 'Ältere Modelle: GPT-4o, GPT-4.1, o-Serie',
    imgTokenTileDesc: 'Das Bild wird auf maximal 2048×2048 skaliert, dann wird die kürzeste Seite auf 768px skaliert. Das Ergebnis wird in 512×512 Kacheln gezählt. Jede Kachel kostet eine feste Anzahl Tokens (z.B. 170) plus Basis-Tokens (z.B. 85).',
    imgTokenDetailTitle: 'Detail-Stufen',
    imgTokenDetailLow: 'Niedrig — Feste 512×512 Verkleinerung, günstigste Option',
    imgTokenDetailHigh: 'Hoch — Standardverarbeitung in voller Auflösung',
    imgTokenDetailOriginal: 'Original — Bis zu 6000px, verfügbar ab GPT-5.4+',
    imgTokenDetailAuto: 'Auto — Modell entscheidet die Stufe',
    imgTokenCalcTitle: 'Kostenberechnung (Patch-basiert)',
    imgTokenCalcStep1: 'patches = ⌈breite / 32⌉ × ⌈höhe / 32⌉',
    imgTokenCalcStep2: 'Wenn patches > Budget → proportional verkleinern',
    imgTokenCalcStep3: 'finale_tokens = skalierte_patches × modell_multiplikator',
    imgTokenCalcExample: 'Beispiel: Ein 1024×1024 Bild → ⌈1024/32⌉ × ⌈1024/32⌉ = 32 × 32 = 1.024 Patches. Mit GPT-5-mini (1,62× Multiplikator) → ~1.660 Tokens.',
    imgTokenFormats: 'Unterstützte Formate: PNG, JPEG, WEBP, nicht-animiertes GIF. Bis zu 50 MB pro Anfrage, bis zu 500 Bilder pro Anfrage.',
    imgTokenLimitationsTitle: 'Bekannte Einschränkungen',
    imgTokenLimitation1: 'Medizinische/wissenschaftliche Bilder — nicht für diagnostische Genauigkeit trainiert',
    imgTokenLimitation2: 'Nicht-lateinischer Text und kleiner Text — OCR-Qualität sinkt deutlich',
    imgTokenLimitation3: 'Gedrehte oder umgedrehte Bilder — Orientierung kann falsch interpretiert werden',
    imgTokenLimitation4: 'Räumliches Denken — Schwierigkeiten mit präzisen Positionen und Entfernungen',
    imgTokenLimitation5: 'Objekte zählen — unzuverlässig ab ~10 Objekten',
    // Use cases
  ...
  agentContext: {
    ...
    pitfallOverflowDesc: 'Wird das Kontextfenster überschritten, kommt es zu Kürzungen. Das Modell verliert den Zugriff auf frühere Informationen und vergisst womöglich Anweisungen oder wichtigen Kontext.',
    ...
    pitfallMiddleDesc: 'Modelle schenken Informationen in der Mitte langer Kontexte weniger Aufmerksamkeit. Platziere kritische Informationen am Anfang oder am Ende.',
  ...
  mcp: {
    ...
    vsCliMcpPro1: 'Strukturierter JSON Input/Output — kein Parsing nötig',
    vsCliMcpPro2: 'Typisierte Schemas mit Validierung — LLM kennt exakte Parameter',
    vsCliMcpPro3: 'Persistente Verbindungen — zustandsbehaftete Sessions (z.B. DB-Connection-Pools)',
    vsCliCliPro1: 'Null Setup — wenn das CLI existiert, funktioniert es sofort',
    vsCliCliPro2: 'Riesiges Ökosystem — tausende Tools auf jedem System bereits installiert',
    vsCliCliPro3: 'Komponierbar — pipe, grep, jq, awk für komplexe Transformationen',
    vsCliRowSetup: 'Setup',
    vsCliRowSetupMcp: 'Config + Server-Prozess',
    vsCliRowSetupCli: 'Bereits installiert',
    vsCliRowSpeed: 'Latenz',
    vsCliRowSpeedMcp: 'Protokoll-Overhead',
    vsCliRowSpeedCli: 'Direkte Ausführung (~ms)',
    vsCliRowSecurity: 'Sicherheit',
    vsCliRowSecurityMcp: 'Sandboxed, granulare Berechtigungen',
    vsCliRowSecurityCli: 'Voller Shell-Zugriff ⚠️',
    vsCliRowEcosystem: 'Ökosystem',
    vsCliRowEcosystemMcp: '~3K Server (wachsend)',
    vsCliRowEcosystemCli: '~100K+ Tools (ausgereift)',
  ...
  diffusionFundamentals: {
    ...
    interactiveTitle: 'Rauschen-zu-Signal-Visualisierung',
    interactiveDesc: 'Passe Rauschen manuell an oder nutze Vorwärts-/Rückwärts-Autoplay, um zu sehen, wie Struktur verschwindet und wieder erscheint.',
    keyTakeaways: 'Wichtige Erkenntnisse',
    takeaway1: 'Diffusionstraining lernt die Umkehrung eines bekannten Korruptionsprozesses.',
    takeaway2: 'Rückwärtssampling ist iterative Verfeinerung, keine Ein-Schritt-Generierung.',
  ...
  textDiffusion: {
    ...
    paddingTokensDesc: 'Gebatchte Diffusion verwendet oft feste Sequenzlängen. [PAD]-Tokens füllen ungenutzte Positionen, und Attention-Masks verhindern Einfluss auf Inhalts-Tokens.',
    ...
    interactiveDesc: 'Beobachte, wie [MASK]-Positionen Token für Token aufgedeckt und verfeinert werden, während [PAD]-Positionen per Maskierung ausgeschlossen bleiben.',
    keyTakeaways: 'Wichtige Erkenntnisse',
  ...
  imageDiffusion: {
    ...
    latentPipelineDesc: 'Moderne Systeme diffundieren meist im latenten Raum: Bildlatente mit einem VAE kodieren, diese Latente entrauschen und anschliessend zurück in Pixel dekodieren.',
    ...
    interactiveTitle: 'Interaktive Rausch- und Entrausch-Demo',
    interactiveDesc: 'Nutze den Visualizer, um Vorwärtsrauschen und Rückwärts-Entrauschen in einem diffusionsähnlichen Prozess zu simulieren.',
    keyTakeaways: 'Wichtige Erkenntnisse',
    takeaway1: 'Latente Diffusion steigert Recheneffizienz bei hoher Bildqualität.',
  ...
  programmaticTools: {
    ...
    whyMattersDesc: 'Traditionelle Tool-Nutzung erfordert, dass das Modell einen Tool-Aufruf generiert, auf das Ergebnis wartet und dann den nächsten Schritt entscheidet — ein Roundtrip nach dem anderen. Programmatische Tool-Aufrufe eliminieren diesen Overhead für mehrstufige Workflows.',
    ...
    traditionalFlow: 'Jeder Tool-Aufruf erfordert einen vollen Modell-Roundtrip. Für N Tools sind das N Inferenz-Durchläufe.',
    programmaticFlow: 'Agent schreibt ein Skript, das N Tools aufruft. Nur 1 Inferenz-Durchlauf nötig.',
    ...
    programmaticSteps: 'Modell → Code (3 Tool-Aufrufe + Aggregation) → Antwort',
    traditionalLabel: '7 Modell-Turns',
    programmaticLabel: '2 Modell-Turns',
    ...
    allowedCallersDesc: 'Bei der Tool-Definition gibst du an, welche Kontexte das Tool aufrufen können. So steuerst du, ob ein Tool nur direkt vom Modell, nur aus der Code-Ausführung oder beides aufgerufen werden kann.',
    ...
    codeOnlyDesc: 'Das Tool kann nur aus einer Sandbox-Code-Ausführungsumgebung heraus aufgerufen werden.',
    ...
    takeaway2: 'Zwischenergebnisse bleiben in der Sandbox und gelangen nie ins Kontextfenster des Modells — spart Tokens.',
    takeaway3: 'Mit allowed_callers steuerst du, ob Tools direkt, aus Code oder beides aufgerufen werden.',
  ...
  trainingData: {
    ...
    futureRegulationDesc: 'Der EU AI Act verlangt Transparenz über Trainingsdaten für Hochrisiko-KI-Systeme. Urheberrechtsklagen schaffen rechtliche Präzedenzfälle. Der Trend geht zu mehr Offenlegung und potenziellen Lizenzanforderungen für Trainingsdaten.',
  ...
  visualChallenges: {
    ...
    challenge1WhyDesc: 'Bildmodelle verarbeiten Bilder als Patches (typischerweise 14x14 oder 16x16 Pixel), nicht als diskrete Objekte. Ihnen fehlt das eingebaute Konzept der "Objektpermanenz" und sie haben Schwierigkeiten, genau Zählungen über überlappende oder dichte Anordnungen aufrechtzuerhalten.',
    ...
    challenge2WhyDesc: 'Positionsinformationen werden durch Patch-Positionseinbettungen kodiert, aber diese bieten keine Pixel-genau Präzision. Das Modell lernt statistische Korrelationen zwischen Positionen statt explizites räumliches Denken.',
  ...
  agenticVision: {
    ...
    model1: 'Google Gemini 3.5 Flash',
    ...
    model3Desc: 'Kombiniert große Reasoning-Modelle mit verstärkungslernbasierter UI-Interaktion und ermöglicht pixelgenaus Zeigen auf Objekte und UI-Elemente.',
  ...
  visualChallengesDemo: {
    ...
    spatialWhy: 'Positionsinformationen werden durch Patch-Einbettungen ohne Pixel-genau Prazision kodiert. Das Modell lernt statistische Korrelationen anstatt explizites raumliches Denken, was Links/Rechts-Verwechslungen haufig macht.',
  ...
  kvCache: {
    ...
    whyMatters: 'Warum es wichtig ist',
    whyMattersDesc: 'Ohne KV-Caching würde die Generierung jedes neuen Tokens erfordern, die gesamte Sequenz durch jede Attention-Schicht neu zu verarbeiten. Bei einer 4096-Token-Sequenz bedeutet das 4096× redundante Berechnung pro Token.',
    ...
    turboQuantDesc: 'Klassische Vektor-Quantisierung addiert 1–2 Extra-Bits Overhead pro Zahl, weil sie Quantisierungskonstanten (Zero Point + Scale) pro Datenblock in voller Präzision speichern muss. Googles drei-Paper-Familie eliminiert diesen Overhead komplett und erreicht State-of-the-Art Kompressionsraten ohne Qualitätsverlust. TurboQuant (ICLR 2026) ist das Gesamtsystem; PolarQuant (AISTATS 2026) übernimmt die Hauptkompression; QJL (AAAI 2025) korrigiert den Restfehler.',
    polarQuantTitle: 'PolarQuant — der Kern-Kompressor',
    polarQuantDesc: 'Statt kartesische Koordinaten (x, y, z…) zu quantisieren und einen Scale-Faktor pro Block zu speichern, wandelt PolarQuant jeden KV-Vektor in Polarkoordinaten um: ein Radius (wie stark das Signal ist) und Winkel (in welche Richtung es zeigt). Nach einem zufälligen Rotations-Preconditioner folgen die Winkel einer bekannten, eng konzentrierten Verteilung — kein Scale-Faktor nötig. Ergebnis: >4,2× KV-Cache-Kompression bei bester Qualität auf Long-Context-Benchmarks.',
    qjlTitle: 'QJL — der 1-Bit Fehlerkorrektur',
    qjlDesc: 'Nach PolarQuant bleibt ein kleiner Restfehler. QJL nutzt die Johnson-Lindenstrauss-Transformation, um diesen Restfehler auf ein einzelnes Vorzeichen-Bit (+1/−1) pro Dimension zu projizieren — null Overhead. Ein spezieller Estimator verwendet diese Bits, um das Skalarprodukt zu entbiasen und genaue Attention-Scores wiederherzustellen. Im Prinzip ein mathematischer Fakten-Checker der fast nichts kostet.',
    whyNewTitle: 'Warum das für Inferenz wichtig ist',
    turboQuantInteractiveTitle: 'Schritt für Schritt: Wie TurboQuant einen Vektor komprimiert',
    turboQuantInteractiveSubtitle: 'Sieh wie ein KV-Vektor von 96 auf 32 Bits schrumpft — ohne Qualitätsverlust',
    whyNewDesc: 'Llama 3 70B braucht bei 128K Kontext ~32 GB nur für den KV-Cache in FP16. Mit 4,2× Kompression schrumpft das auf ~7,6 GB — potenziell der Unterschied zwischen einer und zwei GPUs. Getestet auf LongBench, Needle-in-a-Haystack, RULER, L-Eval mit Gemma und Mistral: Qualität bleibt auf FP16-Niveau bei diesen Kompressionsraten.',
    keyTakeaways: 'Wichtige Erkenntnisse',
    ...
    takeaway2: 'Ohne KV-Cache erfordert jedes neue Token O(n) Attention-Berechnung über die gesamte Sequenz; mit Cache wird nur das K/V des neuen Tokens berechnet',
  ...
  batching: {
    ...
    takeaway5: 'Die Pro-Nutzer-Geschwindigkeit sinkt immer mit mehr gleichzeitigen Nutzern — das System tauscht individuelle Geschwindigkeit gegen Gesamtkapazität',
  },
  ...
  abliteration: {
    ...
    diagramAblatedDesc: 'Das Modell kann die Weigerungsrichtung nicht mehr repräsentieren — es wird keine Anfrage mehr verweigern.',
    diagramActiveDesc: 'Layer 16 hat die stärkste Weigerungsrichtung. Dieser eine Vektor steuert, ob das Modell „Ich kann Ihnen dabei nicht helfen" sagt.',
  ...
  promptCaching: {
    ...
    hitResult: '⚡ 90% günstiger, ~3× schneller',
    ...
    anthropicDesc: 'Explizites Opt-in über den cache_control-Parameter. Markiere bestimmte Inhaltsblöcke als cachebar. 90% Kostenreduktion bei gecachten Tokens, ~3× Latenzverbesserung. Minimum 1.024 Tokens zum Cachen. Cache-TTL ist 5 Minuten (wird bei Hit erneuert).',
    openaiTitle: 'OpenAI (GPT-4o)',
    openaiDesc: 'Automatisch — keine Codeänderungen nötig. Die API cached automatisch passende Präfixe ab 1.024+ Tokens. 50% Rabatt auf gecachte Input-Tokens. Caching passiert transparent im Hintergrund.',
    googleTitle: 'Google (Gemini)',
    googleDesc: 'Explizit über die Context Caching API. Erstelle benannte Cache-Objekte mit konfigurierbarer TTL. 75% Rabatt auf gecachte Tokens. Am besten für sehr große Kontexte (32k+ Tokens), die über viele Anfragen wiederverwendet werden.',
    ...
    notIdeal2: 'Sehr kurze Prompts (unter 1.024 Tokens) — unter der Caching-Schwelle',
    ...
    tip2Desc: 'Anthropic erfordert mindestens 1.024 Tokens in einem cachebaren Block (2.048 für Claude Haiku). Inhalte unter dieser Schwelle werden nicht gecacht.',
    tip3Title: 'TTL verstehen',
    tip3Desc: 'Anthropics Cache lebt 5 Minuten, wird bei jedem Hit erneuert. Bei seltenen Anfragen kann der Cache zwischen Aufrufen ablaufen. OpenAIs automatisches Caching hat eine ähnliche zeitbasierte Verfallszeit.',
    ...
    takeaway2: 'Anthropic bietet die besten Einsparungen (90% Kosten, ~3× Geschwindigkeit) mit explizitem cache_control. OpenAI macht es automatisch mit 50% Ersparnis.',
    ...
    animTitle: 'Prompt-Struktur',
    animDesc: 'Cache Hit hat erhebliche Zeit und Kosten gespart, indem vorberechnete KV-Paare wiederverwendet wurden!',
    ...
    costModelDesc: 'Eine nützliche Faustregel: Cache-Schreibvorgänge sind oft teurer als normale Eingaben, Cache-Lesevorgänge günstiger, und der Break-even-Punkt hängt davon ab, wie oft dasselbe Präfix vor Ablauf wiederverwendet wird. Nutze den Rechner, um Intuition aufzubauen, und bestätige die Werte dann mit echten Usage-Feldern aus deinen API-Antworten.',
  ...
  vramCalc: {
    ...
    moeStrategy2Desc: 'Die meisten MoE-Modelle aktivieren 2-4 von 64+ Experten. Die inaktiven können im CPU-RAM liegen — sie werden während der Inferenz sowieso nicht gelesen.',
    moeStrategy3Title: 'Expert-Prefetching nutzen',
    moeStrategy3Desc: 'Fortgeschrittene Runtimes (wie llama.cpp mit --override-kv) können vorhersagen, welche Experten der nächste Token braucht, und sie von CPU→GPU vorladen, während der aktuelle Token verarbeitet wird.',
    moeStrategy4Title: 'Beispiel: Qwen3.5-35B-A3B bei Q4',
    moeStrategy4Desc: 'Gesamtgröße: ~18 GB. Aber nur ~3B Parameter sind pro Token aktiv. Mit smartem Offloading läuft das auf einer 12GB-GPU: Attention + aktive Experten im VRAM (~6 GB), Rest im RAM. Geschwindigkeit: fast gleich wie komplett im VRAM, weil inaktive Experten nicht gelesen werden.',
    moeKeyInsight: 'Kernaussage',
    moeKeyInsightText: 'Bei MoE-Modellen bestimmt VRAM, welche Modelle du STARTEN kannst. Bei Dense-Modellen bestimmt VRAM, wie SCHNELL sie laufen. Ein 35B MoE-Modell mit 3B aktiven Parametern auf einer 12GB-GPU kann schneller sein als ein 14B Dense-Modell auf der gleichen GPU.',
  ...
  mtp: {
    ...
    demoDesc: 'MTP behält meist das Next-Token-Ziel als stärkstes Signal und ergänzt schwächere Hilfsverluste für weiter entfernte Zukunfts-Tokens.',
    ...
    training3Desc: 'Der Next-Token-Loss bleibt meistens zentral, während weiter entfernte Zukunftsverluste gewichtet werden, damit sie helfen ohne das Training zu destabilisieren.',
