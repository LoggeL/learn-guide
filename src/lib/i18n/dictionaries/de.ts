...
export const de: Dictionary = {
  ...
  topicNames: {
    ...
    'speculative-coding': 'Spekulatives Coding',
  ...
  // Speculative Coding Seite
  speculativeCoding: {
    title: 'Spekulatives Coding',
    description: 'Wie KI-Agenten parallele Exploration nutzen, um optimale Lösungen schneller zu finden, indem sie mehrere Ansätze gleichzeitig verfolgen.',

    whatIs: 'Was ist Spekulatives Coding?',
    whatIsDesc: 'Spekulatives Coding ist ein Agentenmuster, bei dem die KI mehrere Lösungspfade parallel erkundet, anstatt sich vorab auf einen einzelnen Ansatz festzulegen. Statt eine Entscheidung zu treffen und ihr linear zu folgen, "spekuliert" der Agent gleichzeitig über mehrere mögliche Richtungen.',
    whatIsDesc2: 'Diese Technik ist besonders effektiv, wenn der optimale Pfad unklar ist, wenn verschiedene Ansätze erhebliche Kompromisse haben, oder wenn frühes Feedback helfen kann, suboptimale Zweige schnell zu eliminieren.',

    cpuInspiration: 'Inspiriert von CPU-Architektur',
    cpuInspirationDesc: 'Das Konzept ist von der spekulativen Ausführung in modernen CPUs abgeleitet, bei der Prozessoren vorhersagen, welcher Code-Zweig als nächstes ausgeführt wird, und mit der Verarbeitung beginnen, bevor sie es sicher wissen. Bei falscher Vorhersage wird die Arbeit verworfen. Bei KI-Agenten wenden wir das gleiche Prinzip auf die Lösungserkundung an.',
    cpuApproach: 'CPU Spekulative Ausführung',
    cpuApproachDesc: 'Sagt Verzweigungsergebnisse voraus und führt Befehle vorab aus. Falsche Vorhersagen werden zurückgerollt, aber korrekte Vorhersagen sparen erheblich Zeit.',
    agentApproach: 'Agenten Spekulatives Coding',
    agentApproachDesc: 'Erkundet mehrere Lösungszweige gleichzeitig. Erfolglose Pfade werden aufgegeben, während erfolgreiche zusammengeführt oder ausgewählt werden.',

    howItWorks: 'Wie es funktioniert',
    howItWorksDesc: 'Der Agent folgt einem strukturierten Prozess, um die Vorteile der parallelen Erkundung zu maximieren und gleichzeitig den Rechenaufwand zu managen.',
    step1Title: 'Zweig-Identifikation',
    step1Desc: 'Der Agent analysiert das Problem und identifiziert mehrere gangbare Ansätze. Jeder Zweig repräsentiert eine eigene Lösungsstrategie mit eigenen Annahmen und Kompromissen.',
    step2Title: 'Parallele Erkundung',
    step2Desc: 'Mehrere Sub-Agenten oder Threads verfolgen verschiedene Zweige gleichzeitig. Jeder erkundet seinen Ansatz unabhängig und baut Teillösungen auf.',
    step3Title: 'Fortschrittsbewertung',
    step3Desc: 'Der Agent überwacht kontinuierlich den Fortschritt über alle Zweige. Sackgassen werden früh durch Validierungsprüfungen, Kompilierungsfehler oder Testfehler erkannt.',
    step4Title: 'Zweig-Auswahl oder Zusammenführung',
    step4Desc: 'Der erfolgreiche Zweig wird basierend auf Erfolgskriterien ausgewählt, oder mehrere erfolgreiche Zweige werden zusammengeführt, um die besten Elemente jedes Ansatzes zu kombinieren.',

    useCases: 'Wann Spekulatives Coding einsetzen',
    useCasesDesc: 'Spekulatives Coding ist am effektivsten in Szenarien, in denen der Lösungsraum unsicher ist oder verschiedene Ansätze unterschiedliche Vorteile haben.',
    useCase1: 'Algorithmus-Auswahl',
    useCase1Desc: 'Wenn mehrere Algorithmen das Problem lösen könnten (z.B. iterativ vs. rekursiv, BFS vs. DFS), beide ausprobieren und den auswählen, der für die spezifische Eingabe am besten funktioniert.',
    useCase2: 'Bibliothek/Framework-Wahl',
    useCase2Desc: 'Prototyp-Implementierungen mit verschiedenen Bibliotheken erstellen, um herauszufinden, welche bessere API-Ergonomie, Leistung oder Kompatibilität mit bestehendem Code bietet.',
    useCase3: 'Debugging-Hypothesen',
    useCase3Desc: 'Wenn ein Bug mehrere Ursachen haben könnte, jede Hypothese parallel untersuchen, anstatt nacheinander eine nach der anderen zu testen.',
    useCase4: 'Architektur-Erkundung',
    useCase4Desc: 'Beim Entwurf einer neuen Funktion mehrere architektonische Ansätze skizzieren, um Kompromisse zu evaluieren, bevor man sich auf die Implementierung festlegt.',

    tradeoffs: 'Abwägungen',
    benefits: 'Vorteile',
    benefit1: 'Schnellere Konvergenz auf optimale Lösungen',
    benefit2: 'Frühzeitige Eliminierung von Sackgassen-Ansätzen',
    benefit3: 'Bessere Erkundung des Lösungsraums',
    benefit4: 'Reduziertes Risiko, bei suboptimalen Pfaden steckenzubleiben',
    challenges: 'Herausforderungen',
    challenge1: 'Höhere Rechenkosten durch parallele Arbeit',
    challenge2: 'Komplexität bei der Verwaltung mehrerer Zweige',
    challenge3: 'Potenzial für verschwendete Arbeit bei aufgegebenen Zweigen',
    challenge4: 'Erfordert klare Erfolgskriterien für die Zweig-Auswahl',

    realWorld: 'Praxis-Beispiel',
    realWorldDesc: 'Betrachten wir einen Agenten, der einen fehlschlagenden Test reparieren soll. Anstatt eine Lösung nach der anderen zu probieren, erkundet er mehrere Hypothesen:',
    exampleComment: '// Agent erhält: "test_user_login schlägt fehl"',
    exampleTask: 'Repariere den fehlschlagenden Test',
    exampleBranch1: 'Zweig A: Authentifizierungs-Logik',
    exampleBranch1Desc: '→ Untersucht Token-Generierung und -Validierung',
    exampleBranch2: 'Zweig B: Datenbank-Zustand',
    exampleBranch2Desc: '→ Prüft Test-Fixtures und Benutzer-Seeding',
    exampleBranch3: 'Zweig C: API-Vertrag',
    exampleBranch3Desc: '→ Verifiziert Request/Response-Format-Änderungen',
    exampleResult: '✓ Zweig B erfolgreich: Fehlendes Benutzer-Fixture gefunden und hinzugefügt',

    keyTakeaways: 'Wichtige Erkenntnisse',
    takeaway1: 'Spekulatives Coding tauscht Rechenleistung gegen schnellere Konvergenz, indem mehrere Pfade gleichzeitig erkundet werden',
    takeaway2: 'Es funktioniert am besten, wenn der Lösungsraum unsicher ist oder Ansätze unterschiedliche Kompromisse haben',
    takeaway3: 'Frühes Beschneiden von Zweigen basierend auf Validierungssignalen minimiert verschwendete Berechnung',
    takeaway4: 'Das Muster ist von CPU spekulativer Ausführung inspiriert, aber auf höherstufige Problemlösung angewandt',
  },
}
