...
export const de: Dictionary = {
  ...
  topicDescriptions: {
    ...
    'tier-list': "Datierte persönliche Modellränge, Favoriten und Erfahrungen.",
  ...
  tierList: {
    ...
    sPlusTierDesc: 'Logges unangefochtener Favorit',
  ...
  vramCalc: {
    ...
    modelNotesDesc: "Persönliche Vorlieben und datierte Rankings. Favoriten und praktische Notizen an einem Ort.",
    modelNotesDate: "Stand des Rankings: 22. August 2026. Notizen zusammengeführt: 13. September 2026. Dies ist keine laufende Verfügbarkeits- oder Benchmarkliste.",
    favouriteHeading: "Die Favoriten",
    favouriteFable: "Fable 5 ist Logges Favorit für anspruchsvolle Arbeit. Diese Vorliebe bleibt hier als persönliche Bewertung genau dieser Version erhalten.",
    favouriteSol: "GPT-5.6 Sol ist Logges praktische Alltagswahl für anspruchsvolles Coding, Agentenarbeit und Infrastrukturaufgaben. Im Ranking unten bleibt es in A-Tier.",
    historicalAvailability: "Die früheren Notizen vom 23. Juni 2026 beschrieben Fable 5 als nicht verfügbar. Verfügbarkeit muss für die konkrete Version geprüft werden; die Live-Seite des Anbieters kann einen Nachfolger beschreiben. Das Ranking hält eine Vorliebe fest und verspricht keinen aktuellen Zugang.",
