...
export const de: Dictionary = {
  ...
  topicDescriptions: {
    ...
    'local-inference': 'LLMs auf eigener Hardware ausführen -- Privatsphaere, Geschwindigkeit, keine API-Kosten',
  ...
  skillComposer: {
    ...
    inputPlaceholder: 'Versuche: "Kannst du diesen Code auf Fehler überpruefen?"',
    ...
    explainDesc: 'Erklaert Code-Funktionalitaet und Konzepte verständlich',
    ...
    chainingStep2: 'Code Review Skill führt die Ueberpruefung durch',
  ...
  localInference: {
    ...
    whyControlDesc: 'Keine Rate-Limits, keine Filter die du nicht gewählt hast, keine überraschenden API-Aenderungen.',
    ...
    toolsDesc: 'Das lokale Inferenz-Oekosystem ist schnell gereift. Hier sind die wichtigsten Tools, von anfängerfreundlich bis produktionsreif.',

    quantTitle: 'Der Quantisierungs-Kompromiss',
    quantDesc: 'Quantisierung ist die Schlüsseltechnologie, die lokale Inferenz praktikabel macht. Durch Reduzierung der Praezision der Modellgewichte passen viel größere Modelle in begrenzten VRAM.',
    quantSummary: 'Ein 70B-Parameter-Modell bei FP16 braucht 140 GB Speicher -- weit jenseits jeder Consumer-GPU. Bei Q4-Quantisierung passt es in 40 GB, was es auf High-End-Consumer-Hardware mit nur geringem Qualitaetsverlust ausführbar macht.',
    ...
    step2Desc: 'Führe nvidia-smi (NVIDIA) oder den Aktivitaetsmonitor (Mac) aus. Das bestimmt welche Modelle du ausführen kannst.',
    ...
    step4Desc: 'Q4 ist der Sweet Spot für die meisten: gute Qualitaet bei vernünftigem VRAM-Verbrauch. Nimm Q8 bei genug Speicher, Q2 wenn es knapp ist.',
    ...
    tip1: 'Kontextlänge beeinflusst VRAM-Verbrauch direkt. Ein 7B-Modell mit 128K Kontext braucht deutlich mehr Speicher als mit 4K. Starte klein und erhoehe nach Bedarf.',
    ...
    tip5: 'Llama 3.2, Mistral, Phi-3 und Qwen 2.5 sind hervorragend für lokale Inferenz. Jedes glaenzt bei anderen Aufgaben -- experimentiere um das Beste für dich zu finden.',
