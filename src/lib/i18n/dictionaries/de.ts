...
export const de: Dictionary = {
  ...
  topicDescriptions: {
    ...
    'local-inference': 'LLMs auf eigener Hardware ausfuehren -- Privatsphaere, Geschwindigkeit, keine API-Kosten',
  ...
  transformerArchitecture: {
    ...
    whatIsDesc: 'Der Transformer ist eine neuronale Netzwerkarchitektur, die 2017 im bahnbrechenden Paper "Attention is All You Need" von Vaswani et al. vorgestellt wurde. Er ersetzte rekurrente und konvolutionale Ansaetze durch einen rein aufmerksamkeitsbasierten Mechanismus, der massive Parallelisierung beim Training ermoeglicht und weitreichende Abhaengigkeiten weit effektiver erfasst. Nahezu jedes moderne grosse Sprachmodell -- GPT, BERT, LLaMA, Claude -- basiert auf dem Transformer.',
    ...
    bycroftDesc: 'Die beste interaktive 3D-Visualisierung von Transformer-Interna. Erkunde Schritt fuer Schritt, Parameter fuer Parameter, wie GPT-artige Modelle Tokens durch Embedding-, Attention- und Feed-Forward-Schichten verarbeiten. Sehr empfehlenswert.',
    ...
    layersTitle: 'Schicht-fuer-Schicht-Explorer',
    ...
    layer_positional_encoding_desc: 'Fuegt jedem Embedding Positionsinformationen hinzu, damit das Modell die Token-Reihenfolge kennt. Verwendet sinusfoermige Funktionen oder gelernte Positionsembeddings.',
    ...
    layer_add_norm_1_desc: 'Eine Residualverbindung addiert den Attention-Output zurueck zum Input, dann stabilisiert Layer-Normalisierung die Werte. Diese Skip-Connection ist entscheidend fuer das Training tiefer Netzwerke.',
    layer_add_norm_1_in: 'Input + Attn',
    layer_add_norm_1_out: 'Normalisiert',
    layer_feed_forward: 'Feed-Forward-Netzwerk',
    layer_feed_forward_desc: 'Ein zweischichtiges MLP, das unabhaengig auf jede Position angewendet wird: erst Expansion auf 4x d_model, dann Nicht-Linearitaet (ReLU/GeLU), dann Rueckprojektion. Hier wird viel "Wissen" des Modells gespeichert.',
    ...
    layer_output_desc: 'Nach allen N Transformer-Schichten projiziert eine finale lineare Schicht die Vektoren auf Vokabulargroesse. Ein Softmax erzeugt Wahrscheinlichkeiten ueber alle moeglichen naechsten Tokens.',
    ...
    layer_detail_ffn_contract: 'Zurueck auf d_model komprimiert',
    layer_detail_norm_before: 'Vorher (variabel)',
    layer_detail_norm_after: 'Nachher (stabil)',
    layer_detail_norm_desc: 'Werte werden zentriert und skaliert fuer stabiles Training',
    ...
    layer_detail_output_desc: 'Softmax ueber Vokabular → Wahrscheinlichkeiten fuer naechstes Token',
    ...
    arch_encoder_decoder_desc: 'Die urspruengliche Architektur. Der Encoder verarbeitet die Eingabe bidirektional, der Decoder generiert Token fuer Token mit Cross-Attention. Verwendet fuer Uebersetzung und Zusammenfassung.',
    arch_encoder_only_desc: 'Nutzt nur den Encoder mit bidirektionaler Attention. Hervorragend fuer Verstaendnisaufgaben wie Klassifikation und Named Entity Recognition. Nicht fuer Textgenerierung konzipiert.',
    arch_decoder_only_desc: 'Nutzt nur den Decoder mit kausaler Masked Attention. Die dominante Architektur moderner LLMs, da sie natuerlich Textgenerierung modelliert und aussergewoehnlich gut skaliert.',
    encoder: 'Encoder',
    decoder: 'Decoder',
    ...
    dataflowIntro: 'Folge einem einzelnen Token durch die gesamte Transformer-Pipeline, von Rohtext bis zur Ausgabewahrscheinlichkeit. Beobachte, wie sich die Tensorform bei jedem Schritt aendert.',
    dataflowTitle: 'Schritt-fuer-Schritt-Datenfluss',
    dataflowDesc: 'Abspielen oder durch die Pipeline scrubben',
    dataflowPlay: 'Animation abspielen',
    dataflowPlaying: 'Laeuft...',
    ...
    flow_attn_output_desc: 'Gewichtete Werte werden ueber Heads konkateniert und zurueck auf d_model projiziert.',
    flow_ffn: 'Feed-Forward',
    flow_ffn_desc: 'Jede Position durchlaeuft ein zweischichtiges MLP mit Expansion auf d_ff (typisch 4x d_model) und zurueck.',
    flow_ffn_output: 'FFN-Ausgabe',
    flow_ffn_output_desc: 'Nach Residualverbindung und Layer-Norm ist die Ausgabe bereit fuer die naechste Transformer-Schicht.',
    flow_logits: 'Ausgabe-Logits',
    flow_logits_desc: 'Finale Projektion auf Vokabulargroesse erzeugt eine Wahrscheinlichkeitsverteilung ueber alle moeglichen naechsten Tokens.',
    conceptsTitle: 'Schluesselkonzepte',
    concept1Title: 'Residualverbindungen',
    concept1Desc: 'Skip-Connections, die den Input jeder Teilschicht direkt zu deren Output addieren. Sie loesen das Vanishing-Gradient-Problem und ermoeglichen das Training sehr tiefer Netzwerke.',
    concept2Title: 'Layer-Normalisierung',
    concept2Desc: 'Normalisiert Aktivierungen ueber die Feature-Dimension zur Stabilisierung des Trainings. Pre-Norm (vor der Teilschicht normalisieren) ist in modernen Architekturen gaengiger geworden.',
    ...
    whyMattersDesc: 'Die Transformer-Architektur ist wohl die wirkungsvollste Innovation in der KI des letzten Jahrzehnts. Sie hat die Skalierungsgesetze freigeschaltet, die moderne LLMs moeglich machen.',
    takeaway1: 'Der Transformer ersetzte RNNs und LSTMs durch vollstaendige Parallelisierung beim Training und reduzierte Trainingszeiten von Wochen auf Tage',
    takeaway2: 'Sein Attention-Mechanismus erfasst weitreichende Abhaengigkeiten, mit denen sequentielle Modelle kaempften',
    takeaway3: 'Die Architektur skaliert bemerkenswert gut -- von 100M-Parameter-BERT bis 1,8T-Parameter-GPT-4 verbessert sich die Leistung vorhersagbar mit der Groesse',
  ...
  localInference: {
    ...
    description: 'Fuehre grosse Sprachmodelle auf deiner eigenen Hardware aus -- keine Cloud, keine API-Keys, keine Limits.',

    whyTitle: 'Warum lokal ausfuehren?',
    whyDesc: 'Modelle auf dem eigenen Rechner zu betreiben bietet Moeglichkeiten, die Cloud-APIs nicht bieten koennen.',
    whyPrivacy: 'Volle Privatsphaere',
    ...
    whyCostDesc: 'Nach der einmaligen Hardware-Investition ist jeder Token kostenlos. Fuehre so viele Anfragen aus wie du willst.',
    whyOffline: 'Offline-Zugang',
    whyOfflineDesc: 'Funktioniert ohne Internet. Nutze KI im Flugzeug, in sicheren Umgebungen oder ueberall ohne Verbindung.',
    whyCustom: 'Volle Anpassung',
    whyCustomDesc: 'Waehle jedes Modell, jede Quantisierung, alle Parameter. Optimiere fuer deinen spezifischen Anwendungsfall.',
    ...
    whyControlDesc: 'Keine Rate-Limits, keine Filter die du nicht gewaehlt hast, keine ueberraschenden API-Aenderungen.',

    hardwareTitle: 'Hardware-Anforderungen',
    hardwareDesc: 'Waehle eine Modellgroesse und Quantisierungsstufe um zu sehen, wie viel VRAM du brauchst und welche GPUs das schaffen.',
    hwModelSize: 'Modellgroesse',
    hwQuantLevel: 'Quantisierung',
    hwVramNeeded: 'Benoetigter VRAM',
    hwSpeed: 'Geschaetzte Geschwindigkeit',
    hwSpeedNote: 'Ungefaehr, variiert je nach GPU und Konfiguration',
    hwGpuCompat: 'GPU-Kompatibilitaet',

    toolsTitle: 'Beliebte Tools',
    toolsDesc: 'Das lokale Inferenz-Oekosystem ist schnell gereift. Hier sind die wichtigsten Tools, von anfaengerfreundlich bis produktionsreif.',

    quantTitle: 'Der Quantisierungs-Kompromiss',
    quantDesc: 'Quantisierung ist die Schluesseltechnologie, die lokale Inferenz praktikabel macht. Durch Reduzierung der Praezision der Modellgewichte passen viel groessere Modelle in begrenzten VRAM.',
    quantSummary: 'Ein 70B-Parameter-Modell bei FP16 braucht 140 GB Speicher -- weit jenseits jeder Consumer-GPU. Bei Q4-Quantisierung passt es in 40 GB, was es auf High-End-Consumer-Hardware mit nur geringem Qualitaetsverlust ausfuehrbar macht.',
    quantLink: 'Tiefer Einblick in Quantisierung',

    startTitle: 'Erste Schritte',
    startDesc: 'Folge diesen fuenf Schritten um von null zum ersten lokalen Modell zu kommen.',
    step1Title: 'Tool waehlen',
    step1Desc: 'Starte mit Ollama oder LM Studio -- sie erledigen alles fuer dich. Wechsle zu llama.cpp oder vLLM wenn du mehr Kontrolle brauchst.',
    step2Title: 'VRAM pruefen',
    step2Desc: 'Fuehre nvidia-smi (NVIDIA) oder den Aktivitaetsmonitor (Mac) aus. Das bestimmt welche Modelle du ausfuehren kannst.',
    step3Title: 'Modellgroesse waehlen',
    step3Desc: 'Starte mit 7B-Modellen. Sie sind schnell, leistungsfaehig und passen auf die meisten GPUs. Wechsle zu 13B oder 70B wenn du mehr brauchst.',
    step4Title: 'Quantisierungsstufe waehlen',
    step4Desc: 'Q4 ist der Sweet Spot fuer die meisten: gute Qualitaet bei vernuenftigem VRAM-Verbrauch. Nimm Q8 bei genug Speicher, Q2 wenn es knapp ist.',
    step5Title: 'Ausfuehren',
    ...
    quickstartDesc: 'So sieht es aus, Ollama zu installieren und dein erstes Modell auszufuehren -- drei Befehle und du chattest.',
    qsReplay: 'Wiederholen',

    tipsTitle: 'Tipps und Tricks',
    tip1: 'Kontextlaenge beeinflusst VRAM-Verbrauch direkt. Ein 7B-Modell mit 128K Kontext braucht deutlich mehr Speicher als mit 4K. Starte klein und erhoehe nach Bedarf.',
    tip2: 'GPU-Offloading teilt ein Modell zwischen GPU und CPU auf. GPU-Geschwindigkeit fuer passende Layer, CPU fuer den Rest. Langsamer als volle GPU, aber groessere Modelle moeglich.',
    tip3: 'Reine CPU-Inferenz funktioniert, ist aber 5-10x langsamer als GPU. Gut zum Testen, weniger fuer interaktive Nutzung. Apple Silicon ist die Ausnahme -- Unified Memory macht CPU-Inferenz schnell.',
    tip4: 'Fuer 8 GB VRAM: 7B Q4. Fuer 12 GB: 7B Q8 oder 13B Q4. Fuer 24 GB: 13B Q8 oder 70B Q4. Fuer 32 GB+: 70B Q4-Q8 komfortabel.',
    tip5: 'Llama 3.2, Mistral, Phi-3 und Qwen 2.5 sind hervorragend fuer lokale Inferenz. Jedes glaenzt bei anderen Aufgaben -- experimentiere um das Beste fuer dich zu finden.',
    tip6: 'Betreibe Modelle als API-Server (Ollama und LM Studio unterstuetzen das) um lokale Modelle in eigene Anwendungen, Skripte und Workflows zu integrieren.',
  },
