...
export const de: Dictionary = {
  ...
  worldModels: {
    ...
    googleGenieDesc: 'Generiert interaktive, spielbare 3D-Welten aus Textbeschreibungen oder einzelnen Bildern.',
    googleGenieDetail: 'Genie 2 erzeugt konsistente, erkundbare 3D-Umgebungen mit realistischer Physik. Nutzer können eine Szene in natürlicher Sprache beschreiben, und das Modell generiert eine interaktive Welt, die Agenten navigieren können. Es unterstützt persistente Objektzustände und physikalisch plausible Interaktionen.',
