...
export const de: Dictionary = {
  ...
  gettingStarted: {
    ...
    getKeyDesc: 'Nutze OpenRouter mit der kostenlosen Auto-Route. Sie wählt automatisch ein verfügbares Gratis-Modell aus — dadurch bleibt dieser Guide bei genau einem klaren Weg, ohne Anbieter- oder Modellvergleich.',
    openrouterDesc: 'OpenRouter Auto (Free) routet deine Anfrage automatisch an ein verfügbares kostenloses Modell. Ideal für den ersten API-Aufruf, weil du kein konkretes Modell auswählen musst.',
    openrouterAutoOnlyDesc: 'OpenRouter Auto (Free) routet deine Anfrage automatisch an ein verfügbares kostenloses Modell. Erstelle einen kostenlosen OpenRouter-Key, füge ihn unten ein und lass das Modell auf Auto (Free).',
    openrouterAutoOnlyNote: 'Dieses Playground bietet absichtlich nur OpenRouter Auto (Free) an, damit Einsteiger keine Anbieter vergleichen oder Modell-IDs auswählen müssen.',
    groqDesc: 'Auf dieser Seite nicht mehr empfohlen: Nutze OpenRouter Auto (Free) für den Einstieg.',
    cerebrasDesc: 'Auf dieser Seite nicht mehr empfohlen: Nutze OpenRouter Auto (Free) für den Einstieg.',
