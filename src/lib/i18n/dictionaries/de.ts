...
export const de: Dictionary = {
  ...
  interactive: {
    ...
    diffusionNoiseTitle: 'Vorwaerts-/Rueckwaerts-Rauschprozess',
    diffusionNoiseDesc: 'Manuell schieben oder Autoplay nutzen, um Signal-zu-Rauschen-Uebergaenge zu sehen.',
    diffusionNoiseLevel: 'Rauschlevel',
    diffusionNoiseSignal: 'Signal-dominiert',
    diffusionNoiseNoisy: 'Rauschen-dominiert',
    diffusionPlayForward: 'Vorwaerts abspielen',
    diffusionPlayReverse: 'Rueckwaerts abspielen',
    diffusionPause: 'Pause',
    diffusionReset: 'Zuruecksetzen',
    diffusionAutoplayHint: 'Vorwaerts-Autoplay simuliert Korruption; Rueckwaerts-Autoplay simuliert Entrauschung.',

    // Text Diffusion Demo
    textDiffusionDemoTitle: 'Iterative Maskenverfeinerung',
    textDiffusionDemoDesc: 'Text-Diffusion deckt Tokens ueber mehrere Entrauschungspassagen auf und verfeinert sie.',
    textDiffusionStart: 'Start',
    textDiffusionReplay: 'Neu starten',
    textDiffusionStepLabel: 'Schritt',
    textDiffusionPhaseReveal: 'Phase: maskierte Tokens aufdecken',
    textDiffusionPhaseRefine: 'Phase: Token-Wahl verfeinern',
    textDiffusionPhaseDone: 'Phase: finale entrauschte Sequenz',
    textDiffusionLegendMask: '[MASK] = unbekanntes Token',
    textDiffusionLegendPad: '[PAD] = aufgefuellter Platzhalter',
    textDiffusionLegendToken: 'Token = aktuelle Modellvermutung',
    textDiffusionPaddingTitle: 'Warum [PAD]-Tokens wichtig sind',
    textDiffusionPaddingDesc: 'Batching mit fester Laenge haelt Tensorformen konstant, aber zusaetzliche Positionen sollen die Inhaltsmodellierung nicht beeinflussen.',
    textDiffusionPaddingPoint1: 'Nutze [PAD], um ungenutzte Sequenzpositionen bis zur festen Laenge aufzufuellen.',
    textDiffusionPaddingPoint2: 'Verwende Attention-Masking, damit Padding-Positionen beim Scoring ignoriert werden.',
    textDiffusionPaddingPoint3: 'So bleiben Berechnung und Training stabil bei gemischten Sequenzlaengen.',
