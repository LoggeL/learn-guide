    ...
    children: [
        ...
        children: [
          {
            ...
            name: 'Core Concepts',
            children: [
              { id: 'agent-loop', name: 'The Agent Loop', path: '/ai/agents/loop', difficulty: 'beginner', lastUpdated: '2026-06-12' },
              { id: 'agent-context', name: 'Context Anatomy', path: '/ai/agents/context', difficulty: 'intermediate', lastUpdated: '2026-06-12' },
          ...
          },
          {
            ...
            children: [
              ...
              { id: 'verifiable-rewards', name: 'Verifiable Rewards', path: '/ai/agents/verifiable-rewards', difficulty: 'expert', lastUpdated: '2026-06-12' },
            ],
          },
          {
            id: 'agents-frontier',
        ...
        children: [
          {
            ...
            children: [
              ...
              { id: 'attention', name: 'Attention Mechanism', path: '/ai/llm/attention', difficulty: 'intermediate', lastUpdated: '2026-06-12' },
          ...
          },
          {
            ...
            children: [
              ...
              { id: 'moe', name: 'Mixture of Experts', path: '/ai/llm/moe', difficulty: 'expert', lastUpdated: '2026-06-12' },
              ...
              { id: 'abliteration', name: 'Abliteration', path: '/ai/llm/abliteration', difficulty: 'expert', lastUpdated: '2026-06-12' },
      ...
      },
      {
        ...
        children: [
          ...
          { id: 'prompt-caching', name: 'Prompt Caching', path: '/ai/llm-inference/prompt-caching', difficulty: 'intermediate', lastUpdated: '2026-06-12' },
      ...
      },
      {
        ...
        children: [
          ...
          { id: 'reinforcement-learning', name: 'Reinforcement Learning', path: '/ai/ml-fundamentals/reinforcement-learning', difficulty: 'intermediate', lastUpdated: '2026-06-12' },
