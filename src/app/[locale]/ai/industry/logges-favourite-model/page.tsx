...
export default function Opus45Page() {
  ...
  const frontierModels = [
    {
      name: t.opus45.opus46Name,
      source: t.opus45.opus46Source,
      desc: t.opus45.opus46Desc,
      highlights: [
        t.opus45.opus46Fact1,
        t.opus45.opus46Fact2,
        t.opus45.opus46Fact3,
        t.opus45.opus46Fact4,
      ],
      href: 'https://www.anthropic.com/claude/opus',
      linkLabel: t.opus45.opus46LinkLabel,
      icon: Brain,
      borderClass: 'border-orange-500/30',
      iconClass: 'text-orange-400',
    },
    {
      name: t.opus45.gpt53Name,
      source: t.opus45.gpt53Source,
      desc: t.opus45.gpt53Desc,
      highlights: [
        t.opus45.gpt53Fact1,
        t.opus45.gpt53Fact2,
        t.opus45.gpt53Fact3,
      ...
      linkLabel: t.opus45.gpt53LinkLabel,
      icon: Trophy,
    ...
    >
      ...
      <section className="rounded-2xl bg-surface/50 border border-border p-6 md:p-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h2 className="text-2xl font-bold font-heading text-gradient">{t.opus45.frontierTitle}</h2>
        </div>
        <p className="text-muted leading-relaxed">{t.opus45.frontierDesc}</p>
        <p className="text-xs text-muted mt-2 mb-6">{t.opus45.frontierDate}</p>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {frontierModels.map((model, i) => (
            <motion.article
              ...
              className={`rounded-2xl bg-surface border ${model.borderClass} p-5`}
            >
              <div className="flex items-center gap-3 mb-3">
                <model.icon size={20} className={model.iconClass} />
                <div>
                  <h3 className="font-bold font-heading text-text">{model.name}</h3>
                  <p className="text-xs text-muted">{model.source}</p>
                </div>
              </div>

              <p className="text-sm text-muted leading-relaxed mb-4">{model.desc}</p>

              <ul className="space-y-2 mb-4">
                {model.highlights.map((fact) => (
                  <li key={fact} className="flex items-start gap-2 text-sm text-text">
      ...
      {/* Endless Chat */}
      <section>
        <h2 className="text-2xl font-bold font-heading text-gradient mb-4">{t.opus45.endlessChat}</h2>
        <div className="p-6 md:p-8 rounded-2xl bg-surface border border-cyan-500/30">
