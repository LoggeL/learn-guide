...
const HEADS: Record<HeadId, {
  ...
  syntax: {
    label: { en: 'Query head A', de: 'Query-Head A' },
    short: { en: 'A', de: 'A' },
    lens: { en: 'Query A', de: 'Query A' },
    icon: Braces,
    color: '#22d3ee',
    ...
    explanation: {
      en: 'Each query head keeps its own Q projection, even when it shares K/V projections. This pattern only illustrates a distinct view.',
      de: 'Jeder Query-Head behält eine eigene Q-Projektion, auch bei geteilten K/V-Projektionen. Dieses Muster illustriert nur eine andere Ansicht.',
    },
  },
  reference: {
    label: { en: 'Query head B', de: 'Query-Head B' },
    short: { en: 'B', de: 'B' },
    lens: { en: 'Query B', de: 'Query B' },
    icon: Link2,
    color: '#a78bfa',
  ...
  topic: {
    label: { en: 'Query head C', de: 'Query-Head C' },
    short: { en: 'C', de: 'C' },
    lens: { en: 'Query C', de: 'Query C' },
    icon: Brain,
    color: '#34d399',
  ...
  position: {
    label: { en: 'Query head D', de: 'Query-Head D' },
    short: { en: 'D', de: 'D' },
    lens: { en: 'Query D', de: 'Query D' },
    icon: Network,
    color: '#fbbf24',
...
const COPY = {
  en: {
    ...
    lensNote: 'Four constructed views out of 8 query heads. Intensities are illustrative, not measured attention or assigned linguistic roles.',
  ...
  de: {
    ...
    lensNote: 'Vier konstruierte Ansichten von 8 Query-Heads. Intensitäten sind Beispiele, keine gemessene Attention oder festgelegten sprachlichen Aufgaben.',
