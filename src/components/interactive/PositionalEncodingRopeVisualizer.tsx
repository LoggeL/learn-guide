...
const copy = {
  en: {
    ...
    formula: 'For aligned unit vectors: angle(qᵢ) − angle(kⱼ) = (i − j) × rotation step',
    tokens: 'Token orbit map',
    absolute: 'current orbit',
    relative: 'relative phase survives translation',
    note: 'Two initially aligned unit vectors in 2D. The cue maps cosine from [−1, 1] to [0, 100]; it is not an attention probability. Real RoPE rotates many dimension pairs at different frequencies, with content-dependent input vectors.',
  ...
  de: {
    ...
    formula: 'Für ausgerichtete Einheitsvektoren: Winkel(qᵢ) − Winkel(kⱼ) = (i − j) × Rotationsschritt',
    tokens: 'Token-Orbitkarte',
    absolute: 'aktueller Orbit',
    relative: 'relative Phase überlebt Verschiebung',
    note: 'Zwei anfangs ausgerichtete Einheitsvektoren in 2D. Der Hinweis bildet den Kosinus von [−1, 1] auf [0, 100] ab und ist keine Attention-Wahrscheinlichkeit. Echtes RoPE rotiert viele Dimensionspaare mit verschiedenen Frequenzen und inhaltsabhängigen Eingangsvektoren.',
