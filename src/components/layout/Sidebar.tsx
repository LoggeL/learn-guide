        ...
        >
          ...
          {(!isCollapsed || isMobileOpen) && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 mt-3 px-1 text-subtle hover:text-muted transition-colors group"
            >
              <Github size={14} className="group-hover:text-text transition-colors" />
